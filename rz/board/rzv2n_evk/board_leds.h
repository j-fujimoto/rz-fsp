 ...
 * @defgroup BOARD_RZV2N_EVK_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the RZV2N EVK board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RZV2N_EVK_LEDS) */
