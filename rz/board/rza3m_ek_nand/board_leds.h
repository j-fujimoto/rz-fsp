...
/*******************************************************************************************************************//**
 * @ingroup RZA_BOARD_RZA3M_EK_NAND
 * @defgroup RZA_BOARD_RZA3M_EK_NAND_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the RZ/A3M reference board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RZA3M_EK_NAND_LEDS) */
