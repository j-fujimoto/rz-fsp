 ...
 * @defgroup BOARD_RZG3E_EVK_LEDS Board LEDs
 * @brief LED information for this board.
 *
 * This is code specific to the RZG3E EVK board. It includes info on the number of LEDs and which pins are they
 * are on.
 *
 * @{
 **********************************************************************************************************************/
...
/** @} (end defgroup BOARD_RZG3E_EVK_LEDS) */
