...
/** I2C clock settings Please refer to the struct iic_master_clock_settings. */
...
/** R_IIC extended configuration Please refer to the struct st_iic_master_extended_cfg. */
