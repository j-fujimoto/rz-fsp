...
/** Configurations for output pins. Please refer to the struct s_gpt_output_pin. */
...
/** Custom GTIOR settings used for configuring GTIOCxA and GTIOCxB pins. Please refer to the struct s_gpt_gtior_setting. */
...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref timer_api_t::open is called. Please refer to the struct st_gpt_instance_ctrl. */
