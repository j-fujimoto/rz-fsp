...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref mhu_api_t::open is called. Please refer to the struct st_mhu_s_instance_ctrl. */
