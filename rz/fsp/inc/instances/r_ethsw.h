...
/** ETHER SWITCH control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::ether_switch_api_t::open is called. */
...
/** ETHER SWITCH control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::ether_switch_api_t::open is called. Please refer to the struct st_ethsw_instance_ctrl. */
...
/** Extend Configuration parameters. Please refer to the struct st_ethsw_extend_cfg. */
...
/** Port mask Please refer to the struct st_ethsw_port_mask. */
...
/** Address in MAC table entry Please refer to the struct st_ethsw_mac_table_entry_addr. */
typedef struct st_ethsw_mac_table_entry_addr ethsw_mac_table_entry_addr_t;

/** Information in MAC table entry */
struct st_ethsw_mac_table_entry_info
{
    ethsw_port_mask_t port_mask;       ///< port mask
    uint32_t          priority;        ///< switching priority
};

/** Information in MAC table entry Please refer to the struct st_ethsw_mac_table_entry_info. */
...
/** MAC table config Please refer to the struct st_ethsw_mac_table_config. */
...
/** Flood domain configuration for unknown frames Please refer to the struct st_ethsw_flood_unknown_config. */
...
/** DLR initilize Please refer to the struct st_ethsw_dlr_init. */
...
/** The parameter for active steam Id table settings Please refer to the struct st_ethsw_efp_asi. */
typedef struct st_ethsw_efp_asi ethsw_efp_asi_t;
...
typedef struct st_ethsw_efp_priority_regeneration
{
...
typedef struct st_ethsw_efp_qci_stream_filter
{
...
struct st_ethsw_efp_gating_check
{
...
/** The parameter for gating check settings Please refer to the struct st_ethsw_efp_gating_check. */
typedef struct st_ethsw_efp_gating_check ethsw_efp_gating_check_t;

/** The parameter for sdu max verification settings **/
struct st_ethsw_efp_sdu_max_verification
{
...
/** The parameter for sdu max verification settings Please refer to the struct st_ethsw_efp_sdu_max_verification. */
typedef struct st_ethsw_efp_sdu_max_verification ethsw_efp_sdu_max_verification_t;

/** The parameter for flow meter settings **/
struct st_ethsw_efp_flow_metering
{
...
/** The parameter for flow meter settings Please refer to the struct st_ethsw_efp_flow_metering. */
typedef struct st_ethsw_efp_flow_metering ethsw_efp_flow_metering_t;

/** The parameter for configuration of interrupt source **/
struct st_ethsw_efp_interrupt_source
{
...
/** The parameter for configuration of interrupt source Please refer to the struct st_ethsw_efp_interrupt_source. */
typedef struct st_ethsw_efp_interrupt_source ethsw_efp_interrupt_source_t;

/** The parameter for getting statistics information of EFP **/
struct st_ethsw_efp_status
{
...
/** The parameter for getting statistics information of EFP Please refer to the struct st_ethsw_efp_status. */
typedef struct st_ethsw_efp_status ethsw_efp_status_t;
 #endif                                /* ETHSW_EFP_FEATURE_SUPPORTED */
...
/** RX Pattern Matcher Function Control Please refer to the struct st_ethsw_rx_pattern_ctrl. */
...
/** The parameter for set/get the Rx pattern matcher function Please refer to the struct st_ethsw_rx_pattern_matcher. */
...
/** Callback parameter of the Rx pattern matcher Please refer to the struct st_ethsw_rx_pattern_event_data. */
...
/** The parameter for set preemptable queue Please refer to the struct st_ethsw_preempt_queue. */
...
/** The parameter for set frame configuration of frame preemption for each ports Please refer to the struct st_ethsw_preempt_port_ctrl_config. */
...
/** The parameter for get preemption status Please refer to the struct st_ethsw_preempt_status. */
...
/** queue gate Please refer to the struct st_ethsw_mmctl_qgate. */
...
/** The parameter for set/get memory pool size function Please refer to the struct st_ethsw_mmctl_pool_size. */
...
/** The parameter for function that assins a memory pool for a queue. Please refer to the struct st_ethsw_mmctl_queue_assign. */
...
/** The parameter for set / get length in bytes of the YELLOW period. Please refer to the struct st_ethsw_yellow_length. */
...
/** The parameter for set / get queue flush event. Please refer to the struct st_ethsw_queue_flush_event. */
...
/** Switch Base Statistics counter Please refer to the struct st_ethsw_statistic_switch_base. */
...
/** MAC Statistics counter Please refer to the struct st_ethsw_statistic_mac. */
typedef struct st_ethsw_statistic_mac ethsw_statistics_mac_t;

 #ifdef ETHSW_EFP_FEATURE_SUPPORTED

/* EFP Statistics counter */
struct st_ethsw_statistics_efp
{
...
/** EFP Statistics counter Please refer to the struct st_ethsw_statistics_efp. */
typedef struct st_ethsw_statistics_efp ethsw_statistics_efp_t;
...
/** Global Discard and 802.3br Statistics counter Please refer to the struct st_ethsw_statistics_8023br. */
...
/** DLR Statistics counter Please refer to the struct st_ethsw_statistics_dlr. */
...
/** The parameter for set CQF enable configuration Please refer to the struct st_ethsw_cqf_enable. */
...
/** Snoop parser config Please refer to the struct st_ethsw_snoop_parser_config. */
...
/** Snoop arithmetic config Please refer to the struct st_ethsw_snoop_arith_config. */
...
/** EEE Please refer to the struct st_ethsw_eee. */
...
/** QoS mode Please refer to the struct st_ethsw_qos_mode. */
...
/** QoS IP priority Please refer to the struct st_ethsw_qos_prio_ip. */
...
/** QoS Ethertype priority Please refer to the struct st_ethsw_qos_prio_type. */
...
/** mirror port config Please refer to the struct st_ethsw_mirror_conf. */
...
/** The parameter for set/get pulse generator. Please refer to the struct st_ethsw_ts_pulse_generator. */
...
/** tdma enable parameter Please refer to the struct st_ethsw_tdma_enable. */
...
/** TDMA schedule entry parameter Please refer to the struct st_ethsw_tdma_schedule_entry. */
...
/** The parameter for set/get TDMA counter 1 function Please refer to the struct st_ethsw_tdma_counter1. */
...
/** Timer enable/disable parameter Please refer to the struct st_ethsw_time_enable. */
...
/** Timestamp parameter Please refer to the struct st_ethsw_timestamp. */
...
/** Transmit timestamp parameter Please refer to the struct st_ethsw_time_transmit. */
...
/** Peer delay info Please refer to the struct st_ethsw_time_peerdelay. */
...
/** offset correction parameter Please refer to the struct st_ethsw_time_offset_correction. */
...
/** Rate correction parameter Please refer to the struct st_ethsw_time_rate_correction. */
...
/** Domain parameter Please refer to the struct st_ethsw_time_domain. */
