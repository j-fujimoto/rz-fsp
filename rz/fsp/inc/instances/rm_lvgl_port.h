...
/** Callback arguments for the FSP LVGL Port Please refer to the struct st_rm_lvgl_port_callback_args. */
...
struct st_rm_lvgl_port_cfg
{
    ...
    void                * p_partial_framebuffer_0;              // Pointer to partial frame buffer 0
    void                * p_partial_framebuffer_1;              // Pointer to partial frame buffer 1
    lv_display_render_mode_t render_mode;                       // Render mode
    lv_display_rotation_t rotation;                             // Rotation angles
    void (* p_callback)(rm_lvgl_port_callback_args_t * p_args); // Pointer to callback function
};

/** Configuration structure for the FSP LVGL Port Please refer to the struct st_rm_lvgl_port_cfg. */
...
/** Instance control block for LVGL Port Please refer to the struct st_rm_lvgl_port_instance_ctrl. */
