...
/*******************************************************************************************************************//**
 * @addtogroup RZT_RM_ETHERCAT_SSC_PORT
 * @{
 **********************************************************************************************************************/
...
/** EtherCAT SSC port control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::ethercat_ssc_port_api_t::open is called. */
...
/** EtherCAT SSC port control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::ethercat_ssc_port_api_t::open is called. Please refer to the struct st_ethercat_ssc_port_instance_ctrl. */
...
/** Extended configuration Please refer to the struct s_ethercat_ssc_port_extend_cfg. */
