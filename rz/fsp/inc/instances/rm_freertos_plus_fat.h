...
/*******************************************************************************************************************//**
 * @addtogroup RZT_RM_FREERTOS_PLUS_FAT
 * @{
 **********************************************************************************************************************/
...
/** FreeRTOS plus FAT private control block. DO NOT MODIFY.  Initialization occurs when RM_FREERTOS_PLUS_FAT_Open is called. Please refer to the struct st_rm_freertos_plus_fat_instance_ctrl. */
