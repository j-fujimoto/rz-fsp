...
/** Control block used by driver. DO NOT INITIALIZE - this structure will be initialized in @ref transfer_api_t::open. Please refer to the struct st_dmac_b_instance_ctrl. */
