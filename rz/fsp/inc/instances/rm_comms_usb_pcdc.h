...
#if BSP_CFG_RTOS == 0
    timer_instance_t const * p_gtm;    ///< Pointer to GTM instance.
#endif
    uint8_t connect_detection_en;
};

/** USB bus configuration Please refer to the struct st_rm_comms_usb_pcdc_extended_cfg. */
...
/** Communications middleware control structure. Please refer to the struct st_rm_comms_usb_pcdc_instance_ctrl. */
