...
{
    SSI_AUDIO_CLOCK_EXTERNAL2 = 0,     ///< Audio clock source is the AUDIO_CLK2 input pin
    SSI_AUDIO_CLOCK_EXTERNAL1 = 1,     ///< Audio clock source is the AUDIO_CLK1 input pin
} ssi_audio_clock_t;
...
/** Channel instance control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZA::i2s_api_t::open is called. */
...
/** Channel instance control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZA::i2s_api_t::open is called. Please refer to the struct st_ssi_instance_ctrl. */
...
/** SSI configuration extension. This extension is optional. Please refer to the struct st_ssi_extended_cfg. */
