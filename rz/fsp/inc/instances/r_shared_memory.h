...
/** Extended configuration Please refer to the struct st_shared_memory_extended_cfg. */
...
/** SHARED_MEMORY control structure. DO NOT INITIALIZE. Please refer to the struct st_shared_memory_instance_ctrl. */
