...
/** INTC_NMI private control block. DO NOT MODIFY. Initialization occurs when R_INTC_NMI_ExternalIrqOpen is called. Please refer to the struct st_intc_nmi_instance_ctrl. */
