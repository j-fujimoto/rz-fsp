...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::spi_api_t::open is called. */
...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::spi_api_t::open is called. Please refer to the struct st_spi_instance_ctrl. */
