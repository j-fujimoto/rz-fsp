...
/** FileX block media private control block. DO NOT MODIFY.  Initialization occurs when RM_FILEX_BLOCK_MEDIA_Open is called. Please refer to the struct st_rm_filex_block_media_instance_ctrl. */
