...
typedef enum e_sci_b_uart_flow_control
{
    ...
    SCI_B_UART_FLOW_CONTROL_CTSRTS          = 5U, ///< Use CTSn_RTSn pin for CTS, external pin for RTS
...
/** UART instance control block. Please refer to the struct st_sci_b_uart_instance_ctrl. */
...
typedef enum e_sci_b_uart_half_data_enable_t
{
    SCI_B_UART_HALF_DATA_DISABLE = 0,  ///< Half Data Function disabled.
    SCI_B_UART_HALF_DATA_ENABLE  = 1,  ///< Half Data Function enabled.
...
/** Register settings to achieve a desired baud rate and modulation duty. Please refer to the struct st_sci_b_baud_setting_t. */
...
/** Configuration settings for controlling the DE signal for RS-485. Please refer to the struct st_sci_b_uart_rs485_setting. */
...
/** Configuration settings for controlling the Half Data Function. Please refer to the struct st_sci_b_uart_sci_b_uart_half_data_setting. */
...
/** UART on SCI device Configuration. Please refer to the struct st_sci_b_uart_extended_cfg. */
