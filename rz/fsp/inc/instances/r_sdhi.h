...
/** SDMMC instance control block.  This is private to the FSP and should not be used or modified by the application. Please refer to the struct st_sdmmc_instance_ctrl. */
...
/** Optional SDHI extension data structure. Please refer to the struct st_sdhi_extended_cfg. */
