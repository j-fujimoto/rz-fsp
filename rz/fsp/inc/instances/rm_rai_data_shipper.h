...
/*******************************************************************************************************************//**
 * @addtogroup RZA_RM_RAI_DATA_SHIPPER
 * @{
 **********************************************************************************************************************/
...
/** Header buffer structure Please refer to the struct st_rai_data_shipper_header_buffer_type. */
typedef struct st_rai_data_shipper_header_buffer_type rai_data_shipper_header_buffer_t;

struct st_rai_data_shipper_data_buffer_type
{
    void   * p_buf;                    // Pointer to data buffer
    uint32_t len;                      // Data buffer length in bytes
};

/* Please refer to the struct st_rai_data_shipper_data_buffer_type. */
typedef struct st_rai_data_shipper_data_buffer_type rai_data_shipper_data_buffer_t;

struct st_rai_data_shipper_tx_info_type
{
...
/* Please refer to the struct st_rai_data_shipper_tx_info_type. */
typedef struct st_rai_data_shipper_tx_info_type rai_data_shipper_tx_info_t;
...
/** RAI_DATA_SHIPPER instance control block. Initialization occurs when RM_RAI_DATA_SHIPPER_Open() is called. Please refer to the struct st_rai_data_shipper_instance_ctrl. */
