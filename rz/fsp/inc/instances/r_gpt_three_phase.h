...
/*******************************************************************************************************************//**
 * @addtogroup RZT_GPT_THREE_PHASE
 * @{
 **********************************************************************************************************************/
...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::three_phase_api_t::open is called. Please refer to the struct st_gpt_three_phase_instance_ctrl. */
