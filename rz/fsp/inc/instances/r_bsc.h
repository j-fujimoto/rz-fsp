...
/** Callback function parameter data. Please refer to the struct st_bsc_callback_args. */
...
struct st_bsc_extended_cfg
{
    ...
    void * p_context;                                         ///< Placeholder for user data.  Passed to the user p_callback in ::bsc_callback_args_t.
};

/** Extended configuration. Please refer to the struct st_bsc_extended_cfg. */
typedef struct st_bsc_extended_cfg bsc_extended_cfg_t;

/** Instance control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::external_bus_api_t::open is called */
...
/** Instance control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::external_bus_api_t::open is called Please refer to the struct st_bsc_instance_ctrl. */
