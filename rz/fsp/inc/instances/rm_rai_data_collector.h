...
struct st_rai_data_collector_frame_buffer_handle_type
{
...
/** Frame buffer (PING PONG buffer) handle Please refer to the struct st_rai_data_collector_frame_buffer_handle_type. */
...
{
#if !defined(BSP_DTC)                                               /* DMAC is used to transfer data */
    dmac_link_cfg_t * p_descriptor;                                 // Array of DMAC transfer information
...
/** RAI_DATA_COLLECTOR extended configuration Please refer to the struct st_rai_data_collector_extended_cfg. */
...
/** RAI_DATA_COLLECTOR instance control block. Initialization occurs when RM_RAI_DATA_COLLECTOR_Open() is called. Please refer to the struct st_rai_data_collector_instance_ctrl. */
