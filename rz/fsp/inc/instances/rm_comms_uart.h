...
/** UART bus configuration Please refer to the struct st_rm_comms_uart_extended_cfg. */
...
/** Communications middleware control structure. Please refer to the struct st_rm_comms_uart_instance_ctrl. */
