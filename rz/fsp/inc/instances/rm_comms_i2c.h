...
/* Mutex structure. Please refer to the struct st_rm_comms_i2c_mutex. */
typedef struct st_rm_comms_i2c_mutex rm_comms_i2c_mutex_t;

/* Semaphore Structure */
struct st_rm_comms_i2c_semaphore
{
  #if BSP_CFG_RTOS == 1                // ThreadX
...
/* Semaphore Structure. Please refer to the struct st_rm_comms_i2c_semaphore. */
typedef struct st_rm_comms_i2c_semaphore rm_comms_i2c_semaphore_t;
 #endif
