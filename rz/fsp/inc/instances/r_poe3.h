...
/** POEn# input signal setting Please refer to the struct st_poe3_poe_input_setting. */
...
/** Extended configuration. Please refer to the struct st_poe3_extended_cfg. */
typedef struct st_poe3_extended_cfg poe3_extended_cfg_t;

/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::poe3_api_t::open is called. */
...
/** Channel control block. DO NOT INITIALIZE.  Initialization occurs when @ref RZT::poe3_api_t::open is called. Please refer to the struct st_poe3_instance_ctrl. */
