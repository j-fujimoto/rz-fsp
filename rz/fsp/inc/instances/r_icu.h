...
struct st_icu_instance_ctrl
{
    ...
    /** Placeholder for user data.  Passed to the user callback in RZT::external_irq_callback_args_t. */
    void * p_context;
};

/** ICU private control block. DO NOT MODIFY.  Initialization occurs when R_ICU_ExternalIrqOpen is called. Please refer to the struct st_icu_instance_ctrl. */
