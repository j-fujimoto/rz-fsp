...
/** Instance control block. DO NOT INITIALIZE.  Initialization occurs when @ref spi_flash_api_t::open is called. Please refer to the struct st_xspi_qspi_instance_ctrl. */
typedef struct st_xspi_qspi_instance_ctrl xspi_qspi_instance_ctrl_t;

typedef fsp_err_t (* xspi_qspi_init_callback_t)(spi_flash_api_t const * p_api, xspi_qspi_instance_ctrl_t * p_ctrl);
