...
/*******************************************************************************************************************//**
 * @ingroup RZT_RENESAS_SECURITY_INTERFACES
 * @defgroup RZT_RSIP_PROTECTED_API RSIP Interface
 * @brief Interface for Renesas Secure IP (RSIP) functions.
 *
 * @section RZT_RSIP_PROTECTED_API_Summary Summary
...
/* State that specifies functions that can be called next. This enum is private. */
typedef enum e_rsip_user_handle_state rsip_user_handle_state_t;
