...
/*******************************************************************************************************************//**
 * Opens the SSI. Implements @ref RZA::i2s_api_t::open.
 *
 ...
 * @return                                 See @ref RZA_RENESAS_ERROR_CODES or functions called by this function for other
 *                                         possible return codes. This function calls:
 *                                             * @ref RZA::st_transfer_api::open
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * Writes data buffer to SSI. Implements @ref RZA::i2s_api_t::write.
 *
...
/*******************************************************************************************************************//**
 * Reads data into provided buffer. Implements @ref RZA::i2s_api_t::read.
 *
...
/*******************************************************************************************************************//**
 * Writes from source buffer and reads data into destination buffer. Implements @ref RZA::i2s_api_t::writeRead.
 *
...
/*******************************************************************************************************************//**
 * Stops SSI. Implements @ref RZA::i2s_api_t::stop.
 *
 ...
 * @retval FSP_ERR_NOT_OPEN      The channel is not opened.
 * @return                       See @ref RZA_RENESAS_ERROR_CODES or lower level drivers for other possible return codes.
 **********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * Mutes SSI on the next frame boundary. Implements @ref RZA::i2s_api_t::mute.
 *
...
/*******************************************************************************************************************//**
 * Gets SSI status and stores it in provided pointer p_status. Implements @ref RZA::i2s_api_t::statusGet.
 *
...
/*******************************************************************************************************************//**
 * Closes SSI. Implements @ref RZA::i2s_api_t::close.
 *
 ...
 * Implements RZA::i2s_api_t::callbackSet
 *
