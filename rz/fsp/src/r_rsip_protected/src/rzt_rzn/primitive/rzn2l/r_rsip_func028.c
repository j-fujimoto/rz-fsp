...
void r_rsip_func028 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x5cc47e85U),
                   bswap_32big(0x966c4075U),
                   bswap_32big(0xc5ec28f7U),
                   bswap_32big(0xd9a5edd4U));
    ...
    WR1_PROG(REG_1600H, 0x0000b7c0U);
    WR1_PROG(REG_1458H, 0x00000000U);
    WR1_PROG(REG_1600H, 0x016e2a38U);
    WR1_PROG(REG_1458H, 0x00000000U);
    WR1_PROG(REG_1600H, 0x00000060U);
    WR1_PROG(REG_1458H, 0x00000000U);
    WR1_PROG(REG_1600H, 0x0000b7c0U);
    WR1_PROG(REG_1458H, 0x00000000U);
    WR1_PROG(REG_1600H, 0x01580b13U);
    WR1_PROG(REG_1458H, 0x00000000U);
    WR1_PROG(REG_1600H, 0x00000080U);
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func100(bswap_32big(0x21b59bcfU),
                   bswap_32big(0x31bac6a6U),
                   bswap_32big(0x9694ac9fU),
                   bswap_32big(0x828d747fU));
