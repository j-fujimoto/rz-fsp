...
void r_rsip_func086 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x92bcc96eU),
                   bswap_32big(0x46d431cfU),
                   bswap_32big(0x159ae673U),
                   bswap_32big(0x61fe14beU));
    ...
    WR1_PROG(REG_1600H, 0x00000080U);
    WR1_PROG(REG_1458H, 0x00000000U);
    r_rsip_func100(bswap_32big(0xae62606eU),
                   bswap_32big(0xc0328f2fU),
                   bswap_32big(0xef80ab0dU),
                   bswap_32big(0x8bcf0471U));
