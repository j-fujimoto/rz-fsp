...
void r_rsip_pb3u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x6ef27bddU),
                   bswap_32big(0xea51803dU),
                   bswap_32big(0xfb9884d2U),
                   bswap_32big(0x19400c01U));
    WR1_PROG(REG_1444H, 0x00020061U);
    WR1_PROG(REG_182CH, 0x00000020U);
    WR1_PROG(REG_1824H, 0x0d008906U);
    WR1_PROG(REG_1408H, 0x000c1000U);
    r_rsip_func220(InData_Text, MAX_CNT, OutData_Text);
    r_rsip_func101(bswap_32big(0xa9faf8c2U),
                   bswap_32big(0x3079f151U),
                   bswap_32big(0xb70a4200U),
                   bswap_32big(0x5d848108U));
}
