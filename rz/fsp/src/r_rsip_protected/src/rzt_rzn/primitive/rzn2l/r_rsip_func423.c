...
void r_rsip_func423 (uint32_t ARG1[], uint32_t ARG2)
{
    ...
    for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0x07a725feU), bswap_32big(0x5e5ec2b7U), bswap_32big(0x6f028ac8U),
                       bswap_32big(0x72834fbcU));
    }

    r_rsip_func100(bswap_32big(0x9f6c0328U),
                   bswap_32big(0x95910a9fU),
                   bswap_32big(0xb353ea95U),
                   bswap_32big(0x7016c7e9U));
