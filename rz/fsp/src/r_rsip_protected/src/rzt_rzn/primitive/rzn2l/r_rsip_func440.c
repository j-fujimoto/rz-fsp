...
void r_rsip_func440 (const uint32_t ARG1[])
{
    ...
    r_rsip_func101(bswap_32big(0x2c16127dU),
                   bswap_32big(0x232a0a3cU),
                   bswap_32big(0x0e03561bU),
                   bswap_32big(0xddb93392U));
    r_rsip_func045();
    r_rsip_subfunc009(bswap_32big(0x00000440U));
    r_rsip_func101(bswap_32big(0x9d67ccdcU),
                   bswap_32big(0xc6ba4d53U),
                   bswap_32big(0x900c9ea1U),
                   bswap_32big(0xe46b0fe1U));
    r_rsip_func046();
    r_rsip_func100(bswap_32big(0x083e6165U),
                   bswap_32big(0xf744d7c5U),
                   bswap_32big(0xe075e53eU),
                   bswap_32big(0x5917b7b8U));
