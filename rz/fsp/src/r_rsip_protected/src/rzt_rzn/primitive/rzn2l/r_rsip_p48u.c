...
void r_rsip_p48u (const uint32_t InData_Text[], uint32_t OutData_Text[], const uint32_t MAX_CNT)
{
    ...
    r_rsip_func100(bswap_32big(0xc5dca872U),
                   bswap_32big(0x29194992U),
                   bswap_32big(0xbc4ebb4eU),
                   bswap_32big(0x95e3de06U));
    WR1_PROG(REG_1608H, 0x00000008U);
    WR1_PROG(REG_1444H, 0x00020061U);
    WR1_PROG(REG_1824H, 0x00000006U);
    WR1_PROG(REG_1408H, 0x000c1000U);
    r_rsip_func220(InData_Text, MAX_CNT, OutData_Text);
    r_rsip_func101(bswap_32big(0x1b376939U),
                   bswap_32big(0xf7931722U),
                   bswap_32big(0x3e787971U),
                   bswap_32big(0x2fcc46ebU));
}
