...
void r_rsip_pb9u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xaaa72e2eU),
                   bswap_32big(0x408903beU),
                   bswap_32big(0xbf9d2805U),
                   bswap_32big(0x9cea59a4U));
    WR1_PROG(REG_1444H, 0x00020061U);
    WR1_PROG(REG_182CH, 0x40000020U);
    WR1_PROG(REG_1824H, 0x0d008906U);
    WR1_PROG(REG_1408H, 0x000c1000U);
    r_rsip_func220(InData_Text, MAX_CNT, OutData_Text);
    r_rsip_func101(bswap_32big(0x22eb7a27U),
                   bswap_32big(0x9e50e089U),
                   bswap_32big(0xdce77397U),
                   bswap_32big(0x4631eda6U));
}
