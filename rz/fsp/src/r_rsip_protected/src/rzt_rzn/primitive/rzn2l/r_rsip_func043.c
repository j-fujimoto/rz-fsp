...
void r_rsip_func043 (void)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x5792adeaU),
                   bswap_32big(0xda6d36f4U),
                   bswap_32big(0x83e41934U),
                   bswap_32big(0xc79e0043U));
    ...
    r_rsip_func100(bswap_32big(0xcce3591eU),
                   bswap_32big(0x75193e56U),
                   bswap_32big(0x53b5a18dU),
                   bswap_32big(0x1ccd25fcU));
    WR1_PROG(REG_1A24H, 0x08000095U);
    r_rsip_subfunc003(0x00890011U);
    r_rsip_func100(bswap_32big(0x7e5021ffU),
                   bswap_32big(0xd1a030c6U),
                   bswap_32big(0x576e972bU),
                   bswap_32big(0x41a7b38cU));
    WR1_PROG(REG_1600H, 0x0000b540U);
    WR1_PROG(REG_1458H, 0x00000000U);
    ...
    r_rsip_func100(bswap_32big(0xe9c4d788U),
                   bswap_32big(0x436a87bdU),
                   bswap_32big(0x5f7e03f2U),
                   bswap_32big(0x53ddaa8eU));
    ...
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x00000000U));
    r_rsip_func100(bswap_32big(0x9c475628U),
                   bswap_32big(0x226f9b38U),
                   bswap_32big(0x819c3a42U),
                   bswap_32big(0x147b5546U));
    WR1_PROG(REG_1A24H, 0x08000085U);
