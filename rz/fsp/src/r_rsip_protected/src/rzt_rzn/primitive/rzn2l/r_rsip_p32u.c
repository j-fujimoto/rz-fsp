...
void r_rsip_p32u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xfba88fb4U),
                   bswap_32big(0x72ca76b6U),
                   bswap_32big(0x7ec4e6c9U),
                   bswap_32big(0x8f5f7e05U));
    WR1_PROG(REG_1444H, 0x00020061U);
    WR1_PROG(REG_182CH, 0x00018020U);
    WR1_PROG(REG_1824H, 0x07008d06U);
    WR1_PROG(REG_1408H, 0x000c1000U);
    r_rsip_func220(InData_Text, MAX_CNT, OutData_Text);
    r_rsip_func101(bswap_32big(0xaf9eb19dU),
                   bswap_32big(0x3cdc9323U),
                   bswap_32big(0x3d186f95U),
                   bswap_32big(0xb24b0621U));
}
