...
void r_rsip_func088 (void)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x34af3a50U),
                   bswap_32big(0xf16725daU),
                   bswap_32big(0x91b0aba1U),
                   bswap_32big(0xc5dd8208U));
    ...
    r_rsip_func103();
    r_rsip_func100(bswap_32big(0xc59714f7U),
                   bswap_32big(0x78c83305U),
                   bswap_32big(0x261c808cU),
                   bswap_32big(0xc266eb85U));
    ...
    r_rsip_func100(bswap_32big(0xbd440123U),
                   bswap_32big(0xc44e03a7U),
                   bswap_32big(0xbfdee18bU),
                   bswap_32big(0x931ac060U));
    ...
    if (CHCK_STS(REG_143CH, 22U, 1U))
    {
        ...
        r_rsip_func101(bswap_32big(0x24a72318U), bswap_32big(0x984dff33U), bswap_32big(0xba2e5f2dU),
                       bswap_32big(0x09da77feU));
    }
    else
    {
        r_rsip_func100(bswap_32big(0x9de882b9U), bswap_32big(0xb3d48160U), bswap_32big(0x1fbeb0ebU),
                       bswap_32big(0x61d66a9bU));
        ...
        WR1_PROG(REG_143CH, 0x00210000U);
        r_rsip_func101(bswap_32big(0xf9c302e2U), bswap_32big(0x0471d77cU), bswap_32big(0xa499468fU),
                       bswap_32big(0x7a007888U));
    }

    r_rsip_func100(bswap_32big(0x04cafb84U),
                   bswap_32big(0x7121c02eU),
                   bswap_32big(0xcb0fbf71U),
                   bswap_32big(0x636fb753U));
    WR1_PROG(REG_143CH, 0x00400000U);
    WR1_PROG(REG_1458H, 0x00000000U);
    if (CHCK_STS(REG_143CH, 22U, 1U))
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xdc9a8d37U), bswap_32big(0xdf247ba9U), bswap_32big(0x45081aadU),
                       bswap_32big(0xede97b33U));
    }
    else
    {
        r_rsip_func100(bswap_32big(0xa36301d5U), bswap_32big(0xba584372U), bswap_32big(0x37d3c1a2U),
                       bswap_32big(0x89a3cce3U));
        ...
        WR1_PROG(REG_143CH, 0x00210000U);
        r_rsip_func100(bswap_32big(0x8546d14bU), bswap_32big(0x050f04c0U), bswap_32big(0x2722c790U),
                       bswap_32big(0xc6569b02U));
        WR1_PROG(REG_143CH, 0x00400000U);
        WR1_PROG(REG_1458H, 0x00000000U);
        if (CHCK_STS(REG_143CH, 22U, 1U))
        {
            WR1_PROG(REG_1600H, 0x00000800U);
            WR1_PROG(REG_1458H, 0x00000000U);
            r_rsip_func101(bswap_32big(0xd4d6011dU), bswap_32big(0x6c2c435aU), bswap_32big(0xc8363e05U),
                           bswap_32big(0x9101f7e3U));
        }
        else
        {
            r_rsip_func100(bswap_32big(0xf6c030a0U), bswap_32big(0x9be17e38U), bswap_32big(0xb7e57281U),
                           bswap_32big(0x260ab084U));
            WR1_PROG(REG_1014H, 0x00000570U);
            ...
            WR1_PROG(REG_143CH, 0x00a10000U);
            r_rsip_func100(bswap_32big(0x1bc2e962U), bswap_32big(0x6f73ac16U), bswap_32big(0xb3a339fdU),
                           bswap_32big(0xac37dd9aU));
            WR1_PROG(REG_143CH, 0x00400000U);
            WR1_PROG(REG_1458H, 0x00000000U);
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                ...
                WR1_PROG(REG_143CH, 0x00000d00U);
                r_rsip_func101(bswap_32big(0xda14d278U),
                               bswap_32big(0xe82550cbU),
                               bswap_32big(0xcfc8317dU),
                               bswap_32big(0x9e10d229U));
            }
            else
            {
                WR1_PROG(REG_1404H, 0x11400000U);
                ...
                r_rsip_func101(bswap_32big(0xe89282abU),
                               bswap_32big(0x86814ffaU),
                               bswap_32big(0x35dd4e52U),
                               bswap_32big(0xce91b997U));
            }
            ...
            WR1_PROG(REG_143CH, 0x00210000U);
            r_rsip_func100(bswap_32big(0x42a1cb3eU), bswap_32big(0x8aefacc3U), bswap_32big(0x3150213fU),
                           bswap_32big(0x16f50636U));
            WR1_PROG(REG_143CH, 0x00400000U);
            WR1_PROG(REG_1458H, 0x00000000U);
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                WR1_PROG(REG_1600H, 0x00000800U);
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func101(bswap_32big(0x9a65872eU),
                               bswap_32big(0xbf37492bU),
                               bswap_32big(0x466e072aU),
                               bswap_32big(0xc5c86d2dU));
            }
            else
            {
                r_rsip_func100(bswap_32big(0xdbe0189bU),
                               bswap_32big(0x46409eedU),
                               bswap_32big(0x8a3d15c9U),
                               bswap_32big(0x6b87c656U));
                WR1_PROG(REG_1014H, 0x00000250U);
                WR1_PROG(REG_101CH, 0x00000070U);
                ...
                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func101(bswap_32big(0xf1310c29U),
                               bswap_32big(0x39d5fb15U),
                               bswap_32big(0x21186a43U),
                               bswap_32big(0x2100b222U));
            }
        }
    }
