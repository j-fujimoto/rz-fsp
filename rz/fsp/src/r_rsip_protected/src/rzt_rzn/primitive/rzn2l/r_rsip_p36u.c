...
void r_rsip_p36u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xc69a1b04U),
                   bswap_32big(0x3767d776U),
                   bswap_32big(0x4e83765cU),
                   bswap_32big(0x52ecb72aU));
    WR1_PROG(REG_1444H, 0x00020061U);
    WR1_PROG(REG_182CH, 0x40018020U);
    WR1_PROG(REG_1824H, 0x07008d06U);
    WR1_PROG(REG_1408H, 0x000c1000U);
    r_rsip_func220(InData_Text, MAX_CNT, OutData_Text);
    r_rsip_func101(bswap_32big(0x9ce7d325U),
                   bswap_32big(0xecddf3a1U),
                   bswap_32big(0x7e94b41aU),
                   bswap_32big(0xa644fb5aU));
}
