...
void r_rsip_func406 (const uint32_t ARG1[])
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x77bac331U),
                   bswap_32big(0x62c38904U),
                   bswap_32big(0xa66a92c8U),
                   bswap_32big(0x3b861fc1U));
    ...
    r_rsip_func100(bswap_32big(0x37ed43e3U),
                   bswap_32big(0x69a54e77U),
                   bswap_32big(0xc3f41696U),
                   bswap_32big(0x3fe562f5U));
    ...
    WAIT_STS(REG_1444H, 31U, 1U);
    WR1_PROG(REG_1420H, bswap_32big(0x014ea649U));
    WAIT_STS(REG_1A28H, 6U, 0U);
    WR1_PROG(REG_143CH, 0x00000900U);
