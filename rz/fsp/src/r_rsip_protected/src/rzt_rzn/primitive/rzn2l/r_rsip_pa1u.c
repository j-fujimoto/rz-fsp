...
void r_rsip_pa1u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x8c47efbcU),
                   bswap_32big(0xfbec9047U),
                   bswap_32big(0x807aeadaU),
                   bswap_32big(0x25d51406U));
    ...
    r_rsip_func215();
    r_rsip_func101(bswap_32big(0x45100e5bU),
                   bswap_32big(0xde2772ebU),
                   bswap_32big(0xd473a2faU),
                   bswap_32big(0xafed8130U));
}
