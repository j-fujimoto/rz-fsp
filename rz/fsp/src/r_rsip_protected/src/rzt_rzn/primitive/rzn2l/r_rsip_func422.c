...
void r_rsip_func422 (const uint32_t ARG1[], uint32_t ARG2)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x10962e9cU),
                   bswap_32big(0xc0563d9aU),
                   bswap_32big(0x1bbfc3adU),
                   bswap_32big(0x967c2f60U));
    ...
    for (jLoop = 0; jLoop < S_RAM[0]; jLoop = jLoop + 1)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xeff43005U), bswap_32big(0x28c6b5ffU), bswap_32big(0x8edef50aU),
                       bswap_32big(0xbdce270bU));
    }
