...
void r_rsip_pa4u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0x26323afbU),
                   bswap_32big(0x63cc1e8fU),
                   bswap_32big(0xc20e28d0U),
                   bswap_32big(0xbd330f8eU));
    ...
    r_rsip_func215();
    r_rsip_func101(bswap_32big(0x93ee4674U),
                   bswap_32big(0xdbb1bde3U),
                   bswap_32big(0x3a7818a3U),
                   bswap_32big(0x4c7c1a76U));
}
