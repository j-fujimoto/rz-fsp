    ...
    else
    {
        ...
        else
        {
            ...
            if (CHCK_STS(REG_143CH, 22U, 1U))
            {
                ...
                r_rsip_func101(bswap_32big(0xb705e56eU),
                               bswap_32big(0x1f42638fU),
                               bswap_32big(0xf3207efdU),
                               bswap_32big(0xbd177a99U));
                r_rsip_func422(InData_Text, iLoop);
                r_rsip_func100(bswap_32big(0x1ac5deebU),
                               bswap_32big(0xed5d8b42U),
                               bswap_32big(0x08dec51dU),
                               bswap_32big(0x37122b35U));
                ...
                RD1_ADDR(REG_1420H, &OutData_Text[iLoop + 3]);
                r_rsip_subfunc009(bswap_32big(0x000000b3U));
                r_rsip_func101(bswap_32big(0x05791992U),
                               bswap_32big(0x77880af1U),
                               bswap_32big(0xbc5a0c96U),
                               bswap_32big(0x7707572eU));
                r_rsip_func423(OutData_Text, iLoop);
                r_rsip_func101(bswap_32big(0xb9c7054dU),
                               bswap_32big(0x22585afeU),
                               bswap_32big(0xee2a1ddaU),
                               bswap_32big(0x10623c69U));
            }
