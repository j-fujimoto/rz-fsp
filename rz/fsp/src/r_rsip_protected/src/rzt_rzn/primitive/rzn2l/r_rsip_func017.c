...
void r_rsip_func017 (uint32_t ARG1)
{
    ...
    (void) oLoop1;
    (void) OFS_ADR;
    r_rsip_func100(bswap_32big(0xb67ea255U),
                   bswap_32big(0x7db84690U),
                   bswap_32big(0xf84b2e6eU),
                   bswap_32big(0xcae3c3a7U));
    ...
    for (oLoop = 0; oLoop < S_RAM[0 + 2]; oLoop = oLoop + 4)
    {
        ...
        WR1_PROG(REG_1458H, 0x00000000U);
        r_rsip_func101(bswap_32big(0xc6265d8aU), bswap_32big(0xd5a9f418U), bswap_32big(0xe8a9becdU),
                       bswap_32big(0x4baa4149U));
    }
