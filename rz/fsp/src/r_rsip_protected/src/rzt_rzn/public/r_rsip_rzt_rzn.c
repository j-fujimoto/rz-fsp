 ...
 *
 * @par Conditions
 * Argument @ref RZT::rsip_wrapped_key_t::type must be supported by both the function and the device,
 * and must also be enabled in the configuration. For more details, please refer to
 * @ref RZT_r-rsip-protected-supported-algorithms "Supported Algorithms" and
 * @ref RZT_r-rsip-protected-configuration "Configuration".
 *
 ...
 *
 * @note See also Section @ref RZT_r-rsip-protected-supported-algorithms "Supported Algorithms".
 **********************************************************************************************************************/
