 ...
 *
 * Implements @ref RZA::rai_data_shipper_api_t::open().
 *
 ...
 * Read data.
 *
 * Implements @ref RZA::rai_data_shipper_api_t::read().
 *
 ...
 *
 * Implements @ref RZA::rai_data_shipper_api_t::write().
 *
 ...
 *
 * Implements @ref RZA::rai_data_shipper_api_t::close().
 *
...
/*******************************************************************************************************************//**
 * @} (end addtogroup RZA_RM_RAI_DATA_SHIPPER)
 **********************************************************************************************************************/
