 ...
 *********************************************************************************************************************/
 ...
 #define BSP_ADDRESS_CM_DDR_SECURE_BASE             (0x60000000)
 #define BSP_ADDRESS_CM_DDR_NONSECURE_BASE          (0x70000000)
 #define BSP_ADDRESS_CA_DDR_BASE                    (0x40000000)
 #define BSP_ADDRESS_DDR_SIZE                       (0x10000000)

 #define BSP_ADDRESS_CM_SPI_SECURE_BASE             (0x80000000)
 #define BSP_ADDRESS_CM_SPI_NONSECURE_BASE          (0x90000000)
