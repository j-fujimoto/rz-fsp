...
#define BSP_FEATURE_ADC_C_UNIT_0_VALID_CONVERSION_RESULT_REGISTER_MASK    (0xFFFU)
...
#define BSP_FEATURE_GPT_OUTPUT_DISABLE_REQUEST_STATUS_MASK                (R_GPT0_GTST_OABLF_Msk | \
                                                                           R_GPT0_GTST_OABHF_Msk | \
