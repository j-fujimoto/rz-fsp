...
{
    DMAC_TRIGGER_EVENT_SOFTWARE_TRIGGER      = 0x3FF,
    ...
    DMAC_TRIGGER_EVENT_ADC_SCANENDA          = 200 | ACK_MODE_BUS_CYCLE_MODE | DETECTION_RISING_EDGE,
    DMAC_TRIGGER_EVENT_ADC_SCANENDB          = 201 | ACK_MODE_BUS_CYCLE_MODE | DETECTION_RISING_EDGE,
    DMAC_TRIGGER_EVENT_ADC_SCANENDC          = 202 | ACK_MODE_BUS_CYCLE_MODE | DETECTION_RISING_EDGE,
    DMAC_TRIGGER_EVENT_ADC_COMPARE_MATCH     = 203 | ACK_MODE_BUS_CYCLE_MODE | DETECTION_RISING_EDGE,
    DMAC_TRIGGER_EVENT_ADC_COMPARE_MISMATCH  = 204 | ACK_MODE_BUS_CYCLE_MODE | DETECTION_RISING_EDGE,
