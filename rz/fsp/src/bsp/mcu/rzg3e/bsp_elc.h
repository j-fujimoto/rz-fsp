 ...
 * */
typedef enum e_elc_event_rzg3e
{
    ...
    ELC_EVENT_IWDT_ELCWUN_CA55        = (141), // WDT Cortex-A55 underflow or refresh error event
    ELC_EVENT_IWDT_ELCWUN_CM33        = (142), // WDT Cortex-M33 underflow or refresh error event
 ...
 #define BSP_ELC_PERIPHERAL_0_MASK         (0xFFFDFFFFU) // ELC event source no.0 to 31 available on this MPU
