 ...
 * */
typedef enum e_elc_event_rzv2n
{
    ...
    ELC_EVENT_IWDT_ELCWUN_OTHER_0     = (143), // WDT OTHER_0 underflow or refresh error event
    ELC_EVENT_IWDT_ELCWUN_OTHER_1     = (144), // WDT OTHER_1 underflow or refresh error event
    ...
    ELC_EVENT_ADC1_ADA_ADELCREQ       = (456), // ADC1 Scan end event
    ELC_EVENT_ADC1_ADA_ELCCONDMTCH    = (457), // ADC1 Compare match
    ELC_EVENT_ADC1_ADA_ELCCONDUNMTCH  = (458), // ADC1 Compare mis-match
    ELC_EVENT_ADC2_ADA_ADELCREQ       = (459), // ADC2 Scan end event
    ELC_EVENT_ADC2_ADA_ELCCONDMTCH    = (460), // ADC2 Compare match
    ELC_EVENT_ADC2_ADA_ELCCONDUNMTCH  = (461), // ADC2 Compare mis-match
    ELC_EVENT_NONE
} elc_event_t;
...
/* ELC-Related Definitions */
 ...
 #define BSP_ELC_PERIPHERAL_1_MASK         (0x00001FFFU) // ELC event source no.32 to 63 available on this MPU.
