...
typedef enum IRQn
{
    ...
    ADC0_ADA_COMPAI_N_IRQn   = 246,    /* IRQ No:246, ADC0 Window compare match (windowA) */
    ADC0_ADA_COMPBI_N_IRQn   = 247,    /* IRQ No:247, ADC0 Window compare match (windowB) */
    ...
    ADC1_ADA_COMPAI_N_IRQn = 314,      /* IRQ No:314, ADC1 Window compare match (windowA) */
    ADC1_ADA_COMPBI_N_IRQn = 315,      /* IRQ No:315, ADC1 Window compare match (windowB) */
    ADC2_ADA_COMPAI_N_IRQn = 316,      /* IRQ No:316, ADC2 Window compare match (windowA) */
    ADC2_ADA_COMPBI_N_IRQn = 317,      /* IRQ No:317, ADC2 Window compare match (windowB) */
...
typedef enum IRQSELn
{
    ...
    USB_U2H1_INT_IRQSELn        = 403,                      /* IRQSEL No: 403, U2H1_INT */
                                                            /* IRQSEL No: 404, Reserved */
                                                            /* IRQSEL No: 405, Reserved */
                                                            /* IRQSEL No: 406, Reserved */
                                                            /* IRQSEL No: 407, Reserved */
    ...
    ADC0_ADA_GCADIREQ_N_IRQSELn = 577,                      /* IRQSEL No: 577, ada_gcadireq_n */
                                                            /* IRQSEL No: 578, Reserved */
                                                            /* IRQSEL No: 579, Reserved */
                                                            /* IRQSEL No: 580, Reserved */
                                                            /* IRQSEL No: 581, Reserved */
                                                            /* IRQSEL No: 582, Reserved */
    ADC1_ADA_ADIREQ_N_IRQSELn   = 583,                      /* IRQSEL No: 583, ada_adireq_n */
    ADC1_ADA_GBADIREQ_N_IRQSELn = 584,                      /* IRQSEL No: 584, ada_gbadireq_n */
    ADC1_ADA_GCADIREQ_N_IRQSELn = 585,                      /* IRQSEL No: 585, ada_gcadireq_n */
    ADC2_ADA_ADIREQ_N_IRQSELn   = 586,                      /* IRQSEL No: 586, ada_adireq_n */
    ADC2_ADA_GBADIREQ_N_IRQSELn = 587,                      /* IRQSEL No: 587, ada_gbadireq_n */
    ADC2_ADA_GCADIREQ_N_IRQSELn = 588,                      /* IRQSEL No: 588, ada_gcadireq_n */
    IRQSEL_NONE
} IRQSELn_Type;
