 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_Open
 *
...
#endif
#if (BSP_FEATURE_CMTW_UNIT_NUM < 2)
    uint32_t base_address = (uint32_t) BSP_FEATURE_CMTW_UNIT_0_REG +
                            (p_cfg->channel * ((uint32_t) R_CMTW1 - (uint32_t) R_CMTW0));
#else
    uint32_t base_address;
    if ((p_cfg->channel) <= BSP_FEATURE_CMTW_UNIT_0_MAX_CHANNEL_NUM)
    {
        base_address = (uint32_t) BSP_FEATURE_CMTW_UNIT_0_REG +
                       ((p_cfg->channel) * ((uint32_t) R_CMTW1 - (uint32_t) R_CMTW0));
    }
    else
    {
        base_address = (uint32_t) BSP_FEATURE_CMTW_UNIT_1_REG +
                       (((p_cfg->channel) - (BSP_FEATURE_CMTW_UNIT_0_MAX_CHANNEL_NUM + 1)) *
                        ((uint32_t) R_CMTW1 - (uint32_t) R_CMTW0));
    }
#endif
 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_Start
 *
 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_Stop
 *
 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_Enable
 *
 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_Disable
 *
 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_PeriodSet
 *
 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_InfoGet
 *
 ...
 *
 * Example:
 * @snippet rzv_r_cmtw_example.c R_CMTW_StatusGet
 *
...
static uint32_t r_cmtw_clock_frequency_get (R_CMTW0_Type * p_cmtw_regs)
{
    uint32_t           clock_freq_hz = R_FSP_SystemClockHzGet(BSP_FEATURE_CMTW_SOURCE_CLOCK);
