 ...
 * As RZ devices do not have separate video memory this function simply calls d1_allocmem.
 *
...
/*******************************************************************************************************************//**
 * Free video memory.
 * As RZ devices do not have separate video memory this function simply calls d1_freemem.
 *
 * @param[in] handle    Pointer to the d1_device object (not used).
 * @param[in] memtype   Type of memory (not used).
 ...
 * As RZ devices do not have separate video memory this function simply returns the passed pointer.
 *
 * @param[in] handle    Pointer to the d1_device object (not used).
 ...
 * As RZ devices do not have separate video memory this function always returns 1.
 *
 * @param[in] handle    Pointer to the d1_device object (not used).
 ...
 * As RZ devices do not have separate video memory this simply calls memcpy.
 *
 * @param[in] handle    Pointer to the d1_device object (not used).
...
d1_int_t d1_cacheblockflush (d1_device * handle, d1_int_t memtype, const void * ptr, d1_uint_t size)
{
    ...
    R_BSP_CACHE_CleanInvalidateRange((uint64_t) ptr, (uint64_t) size);
