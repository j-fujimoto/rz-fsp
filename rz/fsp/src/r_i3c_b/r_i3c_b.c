 ...
 **********************************************************************************************************************/
#include "r_i3c_b.h"
#include "r_i3c_b_cfg.h"

/***********************************************************************************************************************
 * Typedef definitions
 **********************************************************************************************************************/
typedef enum e_i3c_b_internal_state
{
    I3C_B_INTERNAL_STATE_DISABLED,
    I3C_B_INTERNAL_STATE_MASTER_IDLE,
    I3C_B_INTERNAL_STATE_MASTER_ENTDAA        = I3C_EVENT_ADDRESS_ASSIGNMENT_COMPLETE,
    I3C_B_INTERNAL_STATE_MASTER_WRITE         = I3C_EVENT_WRITE_COMPLETE,
    I3C_B_INTERNAL_STATE_MASTER_READ          = I3C_EVENT_READ_COMPLETE,
    I3C_B_INTERNAL_STATE_MASTER_COMMAND_WRITE = I3C_EVENT_COMMAND_COMPLETE,
    I3C_B_INTERNAL_STATE_MASTER_COMMAND_READ  = (I3C_EVENT_COMMAND_COMPLETE | (0x80U)),
    I3C_B_INTERNAL_STATE_SLAVE_IDLE,
    I3C_B_INTERNAL_STATE_SLAVE_IBI = I3C_EVENT_IBI_WRITE_COMPLETE,
} i3c_b_internal_state_t;

typedef enum e_i3c_b_slave_error_recovery_type
{
    I3C_B_SLAVE_ERROR_RECOVERY_TYPE_WRITE = 0,
    I3C_B_SLAVE_ERROR_RECOVERY_TYPE_READ  = 1,
    I3C_B_SLAVE_ERROR_RECOVERY_TYPE_IBI   = 2,
    I3C_B_SLAVE_ERROR_RECOVERY_TYPE_OTHER = 2,
} i3c_b_slave_error_recovery_type_t;

/***********************************************************************************************************************
 * Macro definitions
 **********************************************************************************************************************/
#define I3C_B_OPEN                                     (('I' << 16U) | ('3' << 8U) | ('C' << 0U))

/* Bitfield definitions for Command Descriptor fields. */
#define I3C_B_CMD_DESC_CMD_ATTR_Pos                    (0U)
#define I3C_B_CMD_DESC_CMD_ATTR_Msk                    (7U << I3C_B_CMD_DESC_CMD_ATTR_Pos)
#define I3C_B_CMD_DESC_CND_ATTR_XFER                   (0U)
#define I3C_B_CMD_DESC_CND_ATTR_IMMED_DATA_XFER        (1U)
#define I3C_B_CMD_DESC_CMD_ATTR_ADDR_ASSGN_CMD         (2U)
#define I3C_B_CMD_DESC_TID_Pos                         (3U)
#define I3C_B_CMD_DESC_TID_Msk                         (0x0FU << I3C_B_CMD_DESC_TID_Pos)
#define I3C_B_CMD_DESC_CMD_Pos                         (7U)
#define I3C_B_CMD_DESC_CMD_Msk                         (0xFFU << I3C_B_CMD_DESC_CMD_Pos)
#define I3C_B_CMD_DESC_DEV_INDEX_Pos                   (16U)
#define I3C_B_CMD_DESC_DEV_INDEX_Msk                   (0x01FFU << I3C_B_CMD_DESC_DEV_INDEX_Pos)
#define I3C_B_CMD_DESC_ROC_Pos                         (30U)
#define I3C_B_CMD_DESC_ROC_Msk                         (1U << I3C_B_CMD_DESC_ROC_Pos)
#define I3C_B_CMD_DESC_TOC_Pos                         (31U)
#define I3C_B_CMD_DESC_TOC_Msk                         (1U << I3C_B_CMD_DESC_TOC_Pos)

/* Command Descriptor definitions for Address Assign Commands. */
#define I3C_B_CMD_DESC_ADDR_ASSGN_DEV_COUNT_Pos        (26U)
#define I3C_B_CMD_DESC_ADDR_ASSGN_DEV_COUNT_Msk        (0x0FU << I3C_B_CMD_DESC_ADDR_ASSGN_DEV_COUNT_Pos)

/* Command Descriptor definitions for Regular Transfer Commands. */
#define I3C_B_CMD_DESC_XFER_CP_Pos                     (15U)
#define I3C_B_CMD_DESC_XFER_CP_Msk                     (1U << I3C_B_CMD_DESC_XFER_CP_Pos)
#define I3C_B_CMD_DESC_XFER_HJ_Pos                     (15U)
#define I3C_B_CMD_DESC_XFER_HJ_Msk                     (1U << I3C_B_CMD_DESC_XFER_HJ_Pos)
#define I3C_B_CMD_DESC_XFER_LENGTH_Pos                 (16U)
#define I3C_B_CMD_DESC_XFER_LENGTH_Msk                 (0xFFFFU << I3C_B_CMD_DESC_XFER_LENGTH_Pos)
#define I3C_B_CMD_DESC_XFER_MODE_Pos                   (26U)
#define I3C_B_CMD_DESC_XFER_MODE_Msk                   (0x07U << I3C_B_CMD_DESC_XFER_MODE_Pos)
#define I3C_B_CMD_DESC_XFER_RNW_Pos                    (29U)
#define I3C_B_CMD_DESC_XFER_RNW_Msk                    (1U << I3C_B_CMD_DESC_XFER_RNW_Pos)
#define I3C_B_CMD_DESC_XFER_MODE_I2C_STDBR             (0U)
#define I3C_B_CMD_DESC_XFER_MODE_I2C_EXDBR             (1U)
#define I3C_B_CMD_DESC_XFER_MODE_I3C_B_SDR_EXTBR_X2    (3U)
#define I3C_B_CMD_DESC_XFER_MODE_I3C_B_SDR_EXTBR_X4    (4U)

/* Command Descriptor definitions for Immediate Data Transfer Commands. */
#define I3C_B_CMD_DESC_IMMED_DATA_XFER_BYTE_CNT_Pos    (23U)

/* Bitfield definitions for the Response Status Descriptor fields. */
#define I3C_B_RESP_STATUS_DESC_DATA_LENGTH_Pos         (0U)
#define I3C_B_RESP_STATUS_DESC_DATA_LENGTH_Msk         (0xFFFFU << I3C_B_RESP_STATUS_DESC_DATA_LENGTH_Pos)
#define I3C_B_RESP_STATUS_DESC_TID_Pos                 (24U)
#define I3C_B_RESP_STATUS_DESC_TID_Msk                 (0x0FU << I3C_B_RESP_STATUS_DESC_TID_Pos)
#define I3C_B_RESP_STATUS_DESC_ERR_STATUS_Pos          (28U)
#define I3C_B_RESP_STATUS_DESC_ERR_STATUS_Msk          (0x0FU << I3C_B_RESP_STATUS_DESC_ERR_STATUS_Pos)

/* Bitfield definitions for Receive Status Descriptor fields. */
#define I3C_B_RECV_STATUS_DESC_DATA_LENGTH_Pos         (0U)
#define I3C_B_RECV_STATUS_DESC_DATA_LENGTH_Msk         (0xFFFFU << I3C_B_RECV_STATUS_DESC_DATA_LENGTH_Pos)
#define I3C_B_RECV_STATUS_DESC_CMD_Pos                 (16U)
#define I3C_B_RECV_STATUS_DESC_CMD_Msk                 (0xFFU << I3C_B_RECV_STATUS_DESC_CMD_Pos)
#define I3C_B_RECV_STATUS_DESC_SDR_R_W_TYPE_Pos        (23U)
#define I3C_B_RECV_STATUS_DESC_SDR_R_W_TYPE_Msk        (0x01U << I3C_B_RECV_STATUS_DESC_SDR_R_W_TYPE_Pos)
#define I3C_B_RECV_STATUS_DESC_ERR_STATUS_Pos          (24U)
#define I3C_B_RECV_STATUS_DESC_ERR_STATUS_Msk          (0x07U << I3C_B_RECV_STATUS_DESC_ERR_STATUS_Pos)
#define I3C_B_RECV_STATUS_DESC_TRANSFER_TYPE_Pos       (27U)
#define I3C_B_RECV_STATUS_DESC_TRANSFER_TYPE_Msk       (0x03U << I3C_B_RECV_STATUS_DESC_TRANSFER_TYPE_Pos)
#define I3C_B_RECV_STATUS_DESC_DEV_INDEX_Pos           (29U)
#define I3C_B_RECV_STATUS_DESC_DEV_INDEX_Msk           (0x07U << I3C_B_RECV_STATUS_DESC_DEV_INDEX_Pos)

/* Bitfield definitions for IBI Status Descriptor fields. */
#define I3C_B_IBI_STATUS_DESC_LENGTH_Pos               (0U)
#define I3C_B_IBI_STATUS_DESC_LENGTH_Msk               (0xFFU << I3C_B_IBI_STATUS_DESC_LENGTH_Pos)
#define I3C_B_IBI_STATUS_DESC_IBI_ID_Pos               (8U)
#define I3C_B_IBI_STATUS_DESC_IBI_ID_Msk               (0xFFU << I3C_B_IBI_STATUS_DESC_IBI_ID_Pos)
#define I3C_B_IBI_STATUS_DESC_LAST_STATUS_Pos          (24U)
#define I3C_B_IBI_STATUS_DESC_LAST_STATUS_Msk          (1U << I3C_B_IBI_STATUS_DESC_LAST_STATUS_Pos)
#define I3C_B_IBI_STATUS_DESC_TS_Pos                   (25U)
#define I3C_B_IBI_STATUS_DESC_TS_Msk                   (1U << I3C_B_IBI_STATUS_DESC_TS_Pos)
#define I3C_B_IBI_STATUS_DESC_ERR_STATUS_Pos           (26U)
#define I3C_B_IBI_STATUS_DESC_ERR_STATUS_Msk           (0x7U << I3C_B_IBI_STATUS_DESC_ERR_STATUS_Pos)
#define I3C_B_IBI_STATUS_DESC_IBI_ST_Pos               (31U)
#define I3C_B_IBI_STATUS_DESC_IBI_ST_Msk               (1U << I3C_B_IBI_STATUS_DESC_IBI_ST_Pos)

/* Address that is written by the slave during a Hot Join request. */
#define I3C_B_HOT_JOIN_ADDRESS                         (2U)

/* Mask for flushing the Read, Write, and Command FIFO. */
#define I3C_B_RSTCTRL_FIFO_FLUSH_Msk                   (R_I3C_B_RSTCTL_CMDQRST_Msk | R_I3C_B_RSTCTL_TDBRST_Msk | \
                                                        R_I3C_B_RSTCTL_RDBRST_Msk)

#define I3C_B_MAX_PUSH_PULL_PERIOD                     (0x3FU)

/* Mask for converting the internal state into an I3C event. */
#define I3C_B_INTERNAL_EVENT_MASK                      (0x7FU)
...
void i3c_b_resp_isr(void);
void i3c_b_rx_isr(void);
void i3c_b_tx_isr(void);
void i3c_b_rcv_isr(void);
void i3c_b_ibi_isr(void);
void i3c_b_tmo_isr(void);
void i3c_b_ierr_isr(void);
void i3c_b_st_isr(void);
void i3c_b_sp_isr(void);
void i3c_b_terr_isr(void);
void i3c_b_abort_isr(void);

static uint8_t i3c_b_address_parity(uint8_t address);

#if I3C_B_CFG_MASTER_SUPPORT
static uint32_t i3c_b_xfer_command_calculate(uint32_t dev_index, bool rnw, uint32_t bitrate_setting, bool restart);

#endif
static void i3c_b_fifo_read(i3c_b_instance_ctrl_t * p_ctrl, uint32_t bytes);
static void i3c_b_fifo_write(i3c_b_instance_ctrl_t * p_ctrl);
static void i3c_b_read_buffer_store(i3c_b_instance_ctrl_t * const    p_ctrl,
                                    i3c_b_read_buffer_descriptor_t * p_buffer_descriptor,
                                    uint32_t                         data_word,
                                    uint32_t                         num_bytes,
                                    i3c_event_t                      buffer_full_event);
static uint32_t     i3c_b_read_bytes_remaining_calculate(i3c_b_instance_ctrl_t * p_ctrl, uint32_t data_length);
static uint32_t     i3c_b_next_data_word_calculate(i3c_b_write_buffer_descriptor_t * p_buffer_descriptor);
static i3c_ctrl_t * i3c_b_isr_context_get(void);

#if I3C_B_CFG_MASTER_SUPPORT
static void i3c_b_master_error_recovery(i3c_b_instance_ctrl_t * p_ctrl, bool error_recovery_case_2);

#endif
#if I3C_B_CFG_SLAVE_SUPPORT
static void i3c_b_slave_error_recovery(i3c_b_instance_ctrl_t * p_ctrl, i3c_b_slave_error_recovery_type_t recovery_type);
...
{
    .open                          = R_I3C_B_Open,
    .enable                        = R_I3C_B_Enable,
    .deviceCfgSet                  = R_I3C_B_DeviceCfgSet,
    .masterDeviceTableSet          = R_I3C_B_MasterDeviceTableSet,
    .slaveStatusSet                = R_I3C_B_SlaveStatusSet,
    .deviceSelect                  = R_I3C_B_DeviceSelect,
    .dynamicAddressAssignmentStart = R_I3C_B_DynamicAddressAssignmentStart,
    .commandSend                   = R_I3C_B_CommandSend,
    .write                         = R_I3C_B_Write,
    .read                          = R_I3C_B_Read,
    .ibiWrite                      = R_I3C_B_IbiWrite,
    .ibiRead                       = R_I3C_B_IbiRead,
    .close                         = R_I3C_B_Close,
};
...
/*******************************************************************************************************************//**
 * Configure an I3C_B instance. Implements @ref i3c_api_t::open.
 *
...
{
    i3c_b_instance_ctrl_t * p_ctrl = (i3c_b_instance_ctrl_t *) p_api_ctrl;

#if I3C_B_CFG_PARAM_CHECKING_ENABLE
    FSP_ASSERT(NULL != p_api_ctrl);
    FSP_ASSERT(NULL != p_cfg);
    FSP_ASSERT(NULL != p_cfg->p_callback);
    FSP_ASSERT(NULL != p_cfg->p_extend);
    FSP_ERROR_RETURN(I3C_B_OPEN != p_ctrl->open, FSP_ERR_ALREADY_OPEN);
    ...
    FSP_ASSERT(0 <= p_extend->st_irq);
    FSP_ASSERT(0 <= p_extend->sp_irq);
    FSP_ASSERT(0 <= p_extend->ierr_irq);
    ...
    memset(p_ctrl, 0, sizeof(i3c_b_instance_ctrl_t));

    p_ctrl->open  = I3C_B_OPEN;
    p_ctrl->p_cfg = p_cfg;
    ...
    /* The field will be cleared automatically upon reset completion (See section 'Reset Control Register'
     * in the user's manual).
     */
...
fsp_err_t R_I3C_B_Enable (i3c_ctrl_t * const p_api_ctrl)
{
...
#if I3C_B_CFG_PARAM_CHECKING_ENABLE
    FSP_ASSERT(NULL != p_api_ctrl);
    FSP_ERROR_RETURN(I3C_B_OPEN == p_ctrl->open, FSP_ERR_NOT_OPEN);
    FSP_ERROR_RETURN(I3C_B_INTERNAL_STATE_DISABLED == p_ctrl->internal_state, FSP_ERR_INVALID_MODE);
#endif

    i3c_b_extended_cfg_t const * p_extend = (i3c_b_extended_cfg_t const *) p_ctrl->p_cfg->p_extend;

    /*
     * Write all remaining configuration settings (See Figure 'I3C Communication Flow' in the user's manual).
     *
     * Configure the Normal IBI Data Segment Size used for receiving IBI data.
     */
    uint32_t nqthctl = 6U << R_I3C_B_NQTHCTL_IBIDSSZ_Pos;
     ...
     */
    uint32_t ntie = R_I3C_B_NTIE_RDBFIE0_Msk |
                    R_I3C_B_NTIE_RSPQFIE_Msk |
                    R_I3C_B_NTIE_RSQFIE_Msk;

#if I3C_B_CFG_MASTER_SUPPORT
    if (I3C_DEVICE_TYPE_MAIN_MASTER == p_ctrl->p_cfg->device_type)
    {
        p_ctrl->internal_state = I3C_B_INTERNAL_STATE_MASTER_IDLE;

        /* Enable the Queue Empty/Full Interrupt. */
        ntie |= R_I3C_B_NTIE_IBIQEFIE_Msk;
    ...
    p_ctrl->p_reg->INSTE = R_I3C_B_INSTE_INEE_Msk;

    /* Enable all Bus Status Flags. */
    p_ctrl->p_reg->BSTE = (R_I3C_B_BSTE_STCNDDE_Msk |
                           R_I3C_B_BSTE_SPCNDDE_Msk |
                           R_I3C_B_BSTE_NACKDE_Msk |
                           R_I3C_B_BSTE_TENDE_Msk |
                           R_I3C_B_BSTE_ALE_Msk |
                           R_I3C_B_BSTE_TODE_Msk);

    /* Enable all Transfer Status Flags. */
    p_ctrl->p_reg->NTSTE = (R_I3C_B_NTSTE_TDBEE0_Msk |
                            R_I3C_B_NTSTE_RDBFE0_Msk |
                            R_I3C_B_NTSTE_IBIQEFE_Msk |
                            R_I3C_B_NTSTE_CMDQEE_Msk |
                            R_I3C_B_NTSTE_RSPQFE_Msk |
                            R_I3C_B_NTSTE_TABTE_Msk |
                            R_I3C_B_NTSTE_TEE_Msk |
                            R_I3C_B_NTSTE_RSQFE_Msk);

    /* Enable the Internal Error Interrupt Requests. */
    p_ctrl->p_reg->INIE = R_I3C_B_INIE_INEIE_Msk;

    /* Enable HDR exit pattern Interrupt Requests. */
    p_ctrl->p_reg->BIE = R_I3C_B_BIE_TODIE_Msk;
    ...
    uint32_t ibinctl =
        (uint32_t) (p_extend->ibi_control.notify_rejected_hot_join_requests << R_I3C_B_IBINCTL_NRHJCTL_Pos);
    ibinctl |= (uint32_t) (p_extend->ibi_control.notify_rejected_mastership_requests << R_I3C_B_IBINCTL_NRMRCTL_Pos);
    ibinctl |= (uint32_t) (p_extend->ibi_control.notify_rejected_interrupt_requests << R_I3C_B_IBINCTL_NRSIRCTL_Pos);
    ...
    uint32_t scstlctl = (uint32_t) (p_extend->bitrate_settings.clock_stalling.assigned_address_phase_enable <<
                                    R_I3C_B_SCSTLCTL_AAPE_Pos);
    scstlctl |=
        (uint32_t) (p_extend->bitrate_settings.clock_stalling.parity_phase_enable << R_I3C_B_SCSTLCTL_PARPE_Pos);
    scstlctl |= (uint32_t) (p_extend->bitrate_settings.clock_stalling.ack_phase_enable << R_I3C_B_SCSTLCTL_ACKPE_Pos);
    scstlctl |=
        (uint32_t) (p_extend->bitrate_settings.clock_stalling.clock_stalling_time << R_I3C_B_SCSTLCTL_STLCYC_Pos);
    ...
    uint32_t csecmd =
        (uint32_t) (p_extend->slave_command_response_info.inband_interrupt_enable << R_I3C_B_CSECMD_SVIRQE_Pos);
    csecmd |= (uint32_t) (p_extend->slave_command_response_info.mastership_request_enable << R_I3C_B_CSECMD_MSRQE_Pos);
    csecmd |= (uint32_t) (p_extend->slave_command_response_info.hotjoin_request_enable << R_I3C_B_CSECMD_HJEVE_Pos);

    /* Calculate the value of the CCC Max Data Speed Read Register. */
    uint32_t cmdspr = (uint32_t) p_extend->slave_command_response_info.read_data_rate << R_I3C_B_CMDSPR_MSRDR_Pos;
    cmdspr |= (uint32_t) p_extend->slave_command_response_info.clock_data_turnaround << R_I3C_B_CMDSPR_CDTTIM_Pos;

    /* Calculate the value of the CCC Max Data Speed Rurnaround Register. */
    uint32_t cmdspt = p_extend->slave_command_response_info.read_turnaround_time << R_I3C_B_CMDSPT_MRTTIM_Pos;
    cmdspt |= (uint32_t) p_extend->slave_command_response_info.read_turnaround_time_enable << R_I3C_B_CMDSPT_MRTE_Pos;

    /* Calculate the value of the CCC Exchange Timing Support Information Register. */
    uint32_t cetsm = (uint32_t) (p_extend->slave_command_response_info.oscillator_frequency << R_I3C_B_CETSM_FREQ_Pos) &
                     R_I3C_B_CETSM_FREQ_Msk;
    cetsm |= (uint32_t) (p_extend->slave_command_response_info.oscillator_inaccuracy << R_I3C_B_CETSM_INAC_Pos) &
             R_I3C_B_CETSM_INAC_Msk;

    uint32_t cmrlg = (uint32_t) p_extend->slave_command_response_info.read_length;
    cmrlg |= (uint32_t) p_extend->slave_command_response_info.ibi_payload_length << R_I3C_B_CMRLG_IBIPSZ_Pos;
    ...
    p_ctrl->p_reg->CGDVST  =
        (uint32_t) (p_extend->slave_command_response_info.activity_state << R_I3C_B_CGDVST_ACTMD_Pos);
    ...
    /* Enable the I3C Bus. */
    p_ctrl->p_reg->BCTL |= R_I3C_B_BCTL_BUSE_Msk;
    ...
    R_BSP_IrqCfgEnable(p_extend->st_irq, p_extend->eei_ipl, p_ctrl);
    R_BSP_IrqCfgEnable(p_extend->sp_irq, p_extend->eei_ipl, p_ctrl);
    R_BSP_IrqCfgEnable(p_extend->tmo_irq, p_extend->eei_ipl, p_ctrl);
    R_BSP_IrqCfgEnable(p_extend->ierr_irq, p_extend->eei_ipl, p_ctrl);
    R_BSP_IrqCfgEnable(p_extend->terr_irq, p_extend->eei_ipl, p_ctrl);
    R_BSP_IrqCfgEnable(p_extend->abort_irq, p_extend->eei_ipl, p_ctrl);
...
fsp_err_t R_I3C_B_DeviceCfgSet (i3c_ctrl_t * const p_api_ctrl, i3c_device_cfg_t const * const p_device_cfg)
{
    ...
    if (I3C_DEVICE_TYPE_MAIN_MASTER == p_ctrl->p_cfg->device_type)
    {
         ...
         * in the user's manual).
         */
        uint32_t msdvad = (uint32_t) p_device_cfg->dynamic_address << R_I3C_B_MSDVAD_MDYAD_Pos;
        msdvad               |= R_I3C_B_MSDVAD_MDYADV_Msk;
...
#endif
    {
         ...
         * Provisional ID (See Figure 'I3C Communication Flow' in the user's manual).
         *
         * Configure the device static address. */
        uint32_t sdatbas0 = (uint32_t) p_device_cfg->static_address & R_I3C_B_SDATBAS0_SDSTAD_Msk;

        /* Configure the device dynamic address. */
        sdatbas0 |= (uint32_t) (i3c_b_address_parity(p_device_cfg->dynamic_address) << R_I3C_B_SDATBAS0_SDDYAD_Pos) &
                    R_I3C_B_SDATBAS0_SDDYAD_Msk;

        /* Configure the IBI payload setting based on the BCR register. */
        sdatbas0 |= (uint32_t) (p_device_cfg->slave_info.bcr_b.ibi_payload << R_I3C_B_SDATBAS0_SDIBIPL_Pos) &
                    R_I3C_B_SDATBAS0_SDIBIPL_Msk;

        /* Set the slave address to valid. */
        p_ctrl->p_reg->SVCTL_b.SVAE0 = 1;
        ...
        svdct               |= (uint32_t) p_device_cfg->slave_info.bcr << R_I3C_B_SVDCT_TBCR0_Pos;
                                        ...
                                        i3c_device_table_cfg_t const * const p_device_table_cfg)
{
    ...
    if (I3C_B_DEVICE_INDEX_EXTENDED_DEVICE == device_index)
    {
    ...
    else
    {
        ...
        datbasn |= (uint32_t) (p_device_table_cfg->ibi_payload << R_I3C_B_DATBAS0_DVIBIPL_Pos) &
                   R_I3C_B_DATBAS0_DVIBIPL_Msk;
        datbasn |= (uint32_t) (!p_device_table_cfg->ibi_accept << R_I3C_B_DATBAS0_DVSIRRJ_Pos) &
                   R_I3C_B_DATBAS0_DVSIRRJ_Msk;
        datbasn |= (uint32_t) (!p_device_table_cfg->master_request_accept << R_I3C_B_DATBAS0_DVMRRJ_Pos) &
                   R_I3C_B_DATBAS0_DVMRRJ_Msk;
    }

    /* Configure the device static address. */
    datbasn |= (uint32_t) (p_device_table_cfg->static_address << R_I3C_B_DATBAS0_DVSTAD_Pos) &
               R_I3C_B_DATBAS0_DVSTAD_Msk;

    /* Configure the device dynamic address. */
    datbasn |= (uint32_t) (i3c_b_address_parity(p_device_table_cfg->dynamic_address) << R_I3C_B_DATBAS0_DVDYAD_Pos) &
               R_I3C_B_DATBAS0_DVDYAD_Msk;
    ...
    if (I3C_DEVICE_PROTOCOL_I2C == p_device_table_cfg->device_protocol)
    {
        ...
        datbasn |= R_I3C_B_DATBAS0_DVTYP_Msk;
    }
...
fsp_err_t R_I3C_B_SlaveStatusSet (i3c_ctrl_t * const p_api_ctrl, i3c_device_status_t status)
{
    ...
    FSP_ERROR_RETURN(
        I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state || I3C_B_INTERNAL_STATE_SLAVE_IBI == p_ctrl->internal_state,
        FSP_ERR_INVALID_MODE);
 #endif

    /* Clear the Pending Interrupt and Vendor Reserved fields. */
    uint32_t cgdvst = p_ctrl->p_reg->CGDVST;
    cgdvst &= ~(R_I3C_B_CGDVST_PNDINT_Msk | R_I3C_B_CGDVST_VDRSV_Msk);

    /* Write the new Pending Interrupt and Vendor Reserved fields. */
    cgdvst |= (uint32_t) status.pending_interrupt & R_I3C_B_CGDVST_PNDINT_Msk;
    cgdvst |= (uint32_t) (status.vendor_status << R_I3C_B_CGDVST_VDRSV_Pos) & R_I3C_B_CGDVST_VDRSV_Msk;
...
fsp_err_t R_I3C_B_DeviceSelect (i3c_ctrl_t * const p_api_ctrl, uint32_t device_index, uint32_t bitrate_mode)
{
    ...
    FSP_ASSERT(NULL != p_api_ctrl);
    FSP_ERROR_RETURN(I3C_B_OPEN == p_ctrl->open, FSP_ERR_NOT_OPEN);
    FSP_ASSERT(I3C_B_BITRATE_MODE_I3C_SDR4_EXTBR_X4 >= bitrate_mode);
    FSP_ERROR_RETURN(
        I3C_B_INTERNAL_STATE_SLAVE_IDLE != p_ctrl->internal_state && I3C_B_INTERNAL_STATE_DISABLED != p_ctrl->internal_state,
        FSP_ERR_INVALID_MODE);
    FSP_ASSERT(BSP_FEATURE_I3C_B_MAX_DEV_COUNT > device_index ||
               I3C_B_DEVICE_INDEX_EXTENDED_DEVICE == device_index);
 #endif

    p_ctrl->device_index        = device_index;
    p_ctrl->device_bitrate_mode = (i3c_b_bitrate_mode_t) bitrate_mode;
                                                 ...
                                                 uint32_t                      device_count)
{
    ...
    FSP_ASSERT(BSP_FEATURE_I3C_B_MAX_DEV_COUNT > starting_device_index ||
               I3C_B_DEVICE_INDEX_EXTENDED_DEVICE == starting_device_index);

    if (I3C_ADDRESS_ASSIGNMENT_MODE_ENTDAA == address_assignment_mode)
    {
        if (I3C_B_DEVICE_INDEX_EXTENDED_DEVICE == starting_device_index)
        {
        ...
        else
        {
            ...
            FSP_ASSERT(BSP_FEATURE_I3C_B_MAX_DEV_COUNT > device_count + starting_device_index);
        }
    }
    else
    {
    ...
    FSP_ERROR_RETURN(I3C_B_INTERNAL_STATE_MASTER_IDLE == p_ctrl->internal_state, FSP_ERR_IN_USE);

    p_ctrl->internal_state = I3C_B_INTERNAL_STATE_MASTER_ENTDAA;
    ...
    command_descriptor |= (I3C_B_CMD_DESC_CMD_ATTR_ADDR_ASSGN_CMD << I3C_B_CMD_DESC_CMD_ATTR_Pos);
    command_descriptor |= (uint32_t) (I3C_EVENT_ADDRESS_ASSIGNMENT_COMPLETE << I3C_B_CMD_DESC_TID_Pos);
    command_descriptor |= (uint32_t) (address_assignment_mode << I3C_B_CMD_DESC_CMD_Pos);
    command_descriptor |= (starting_device_index << I3C_B_CMD_DESC_DEV_INDEX_Pos);
    command_descriptor |= (device_count << I3C_B_CMD_DESC_ADDR_ASSGN_DEV_COUNT_Pos);
    command_descriptor |= I3C_B_CMD_DESC_ROC_Msk;
    command_descriptor |= I3C_B_CMD_DESC_TOC_Msk;
     ...
     * the most significant word (See Section "Command Descriptor" in the user's manual).
     */
                               ...
                               i3c_command_descriptor_t const * const p_command_descriptor)
{
  ...
  #if !I3C_B_CFG_UNALIGNED_BUFFER_SUPPORT
    ...
    i3c_b_read_buffer_descriptor_t * p_transfer_descriptor;
    ...
    if (p_command_descriptor->rnw)
    {
        ...
        p_ctrl->internal_state = I3C_B_INTERNAL_STATE_MASTER_COMMAND_READ;
    }
    else
    {
        /* If this is a write transfer, update the write buffer descriptor. */
        p_transfer_descriptor = (i3c_b_read_buffer_descriptor_t *) &p_ctrl->write_buffer_descriptor;

        p_ctrl->internal_state = I3C_B_INTERNAL_STATE_MASTER_COMMAND_WRITE;
    }
    ...
    uint32_t cmd1 = 0;
    cmd1 |= (p_ctrl->device_index << I3C_B_CMD_DESC_DEV_INDEX_Pos) & I3C_B_CMD_DESC_DEV_INDEX_Msk;
    cmd1 |= ((uint32_t) p_ctrl->device_bitrate_mode << I3C_B_CMD_DESC_XFER_MODE_Pos) & I3C_B_CMD_DESC_XFER_MODE_Msk;
    cmd1 |= (uint32_t) (p_command_descriptor->rnw << I3C_B_CMD_DESC_XFER_RNW_Pos);
    cmd1 |= I3C_B_CMD_DESC_ROC_Msk;
    cmd1 |= (uint32_t) (!p_command_descriptor->restart << I3C_B_CMD_DESC_TOC_Pos) & I3C_B_CMD_DESC_TOC_Msk;
    cmd1 |= (uint32_t) (p_command_descriptor->command_code << I3C_B_CMD_DESC_CMD_Pos);
    cmd1 |= I3C_B_CMD_DESC_XFER_CP_Msk;
    cmd1 |= (uint32_t) (I3C_EVENT_COMMAND_COMPLETE << I3C_B_CMD_DESC_TID_Pos);
    ...
    if ((4 >= p_command_descriptor->length) && !p_command_descriptor->rnw)
    {
         ...
         * See Section "Immediate Transfer Command" in the user's manual. */
        cmd1 |= I3C_B_CMD_DESC_CND_ATTR_IMMED_DATA_XFER;
        cmd1 |= (p_command_descriptor->length << I3C_B_CMD_DESC_IMMED_DATA_XFER_BYTE_CNT_Pos);
        cmd2  = i3c_b_next_data_word_calculate(&p_ctrl->write_buffer_descriptor);
        p_ctrl->write_buffer_descriptor.count = p_command_descriptor->length;
    }
    else
    {
        cmd2 = (p_command_descriptor->length << I3C_B_CMD_DESC_XFER_LENGTH_Pos) &
               I3C_B_CMD_DESC_XFER_LENGTH_Msk;
    }
    ...
    if (!p_command_descriptor->rnw && (4 < p_command_descriptor->length))
    {
        ...
        p_ctrl->next_word = i3c_b_next_data_word_calculate(&p_ctrl->write_buffer_descriptor);

        /* Write data to the FIFO. */
        i3c_b_fifo_write(p_ctrl);

        /* If there is still data remaining in the transfer then it will be written in the Write Buffer Empty IRQ. */
        if ((BSP_FEATURE_I3C_B_NTDTBP0_DEPTH * sizeof(uint32_t)) < p_command_descriptor->length)
        {
...
fsp_err_t R_I3C_B_Write (i3c_ctrl_t * const p_api_ctrl, uint8_t const * const p_data, uint32_t length, bool restart)
{
...
#if I3C_B_CFG_SLAVE_SUPPORT
    if (I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state)
    {
        /* In slave mode, ensure that a write transfer is not currently in progress. */
        FSP_ERROR_RETURN(0U == (p_ctrl->p_reg->PRSST & R_I3C_B_PRSST_TRMD_Msk), FSP_ERR_IN_USE);
    }
    else
#endif
    {
    ...
    if (I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state)
    {
        if (p_ctrl->write_buffer_descriptor.p_buffer != NULL)
        {
             ...
             * can be written.
             */
            p_ctrl->p_reg->RSTCTL = R_I3C_B_RSTCTL_TDBRST_Msk;

            /* The field will be cleared automatically upon reset completion (See Section "Reset Control Register" in the user's manual). */
            FSP_HARDWARE_REGISTER_WAIT(p_ctrl->p_reg->RSTCTL, 0U);
        }
    ...
    if ((length > 4) || (I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state))
    {
        ...
        /* If there is still data remaining in the transfer then it will be written in the Write Buffer Empty IRQ. */
        if ((BSP_FEATURE_I3C_B_NTDTBP0_DEPTH * sizeof(uint32_t)) < length)
        {
            /* Enable the Write Buffer Empty IRQ. */
            p_ctrl->p_reg->NTIE_b.TDBEIE0 = 1;
        }
...
#if I3C_B_CFG_MASTER_SUPPORT
    if (I3C_B_INTERNAL_STATE_MASTER_IDLE == p_ctrl->internal_state)
    {
        p_ctrl->internal_state = I3C_B_INTERNAL_STATE_MASTER_WRITE;
         ...
         * the most significant word (See Section "Command Descriptor" in the user's manual).
         */
        uint32_t cmd1 = i3c_b_xfer_command_calculate(p_ctrl->device_index, false, p_ctrl->device_bitrate_mode, restart);
        ...
        if (length <= 4)
        {
             ...
             * See Section "Immediate Transfer Command" in the user's manual. */
            cmd1 |= I3C_B_CMD_DESC_CND_ATTR_IMMED_DATA_XFER;
            cmd1 |= (length << I3C_B_CMD_DESC_IMMED_DATA_XFER_BYTE_CNT_Pos);
            cmd2  = p_ctrl->next_word;
            p_ctrl->write_buffer_descriptor.count = length;
        }
        else
        {
            cmd2 = (length << I3C_B_CMD_DESC_XFER_LENGTH_Pos) & I3C_B_CMD_DESC_XFER_LENGTH_Msk;
        }
...
fsp_err_t R_I3C_B_Read (i3c_ctrl_t * const p_api_ctrl, uint8_t * const p_data, uint32_t length, bool restart)
{
    ...
    /* In Master mode, ensure that driver is in the idle state. */
    FSP_ERROR_RETURN(I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state ||
                     I3C_B_INTERNAL_STATE_MASTER_IDLE == p_ctrl->internal_state,
                     FSP_ERR_IN_USE);
    ...
    if (I3C_B_INTERNAL_STATE_MASTER_IDLE == p_ctrl->internal_state)
    {
        p_ctrl->internal_state = I3C_B_INTERNAL_STATE_MASTER_READ;
         ...
         * the most significant word (See Section "Command Descriptor" in the user's manual).
         */
        p_ctrl->p_reg->NCMDQP = i3c_b_xfer_command_calculate(p_ctrl->device_index,
                                                             true,
                                                             p_ctrl->device_bitrate_mode,
                                                             restart);
        p_ctrl->p_reg->NCMDQP = (length << I3C_B_CMD_DESC_XFER_LENGTH_Pos) & I3C_B_CMD_DESC_XFER_LENGTH_Msk;
                            ...
                            uint32_t              length)
{
    ...
    if ((I3C_IBI_TYPE_INTERRUPT == ibi_type) && (0 != (R_I3C_B_SDATBAS0_SDIBIPL_Msk & p_ctrl->p_reg->SDATBAS0)))
    {
        FSP_ASSERT(NULL != p_data);
        FSP_ASSERT(0 != length);
    }
    ...
    /* This function is only called in slave mode. */
    FSP_ERROR_RETURN(I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state, FSP_ERR_INVALID_MODE);
    ...
    FSP_ERROR_RETURN(I3C_B_INTERNAL_STATE_SLAVE_IBI != p_ctrl->internal_state, FSP_ERR_IN_USE);

    p_ctrl->internal_state = I3C_B_INTERNAL_STATE_SLAVE_IBI;
    ...
    uint32_t command_descriptor = 0;
    command_descriptor |= I3C_B_CMD_DESC_ROC_Msk;
    command_descriptor |= (I3C_EVENT_IBI_WRITE_COMPLETE << I3C_B_CMD_DESC_TID_Pos);

    if (I3C_IBI_TYPE_HOT_JOIN == ibi_type)
    {
        command_descriptor |= I3C_B_CMD_DESC_XFER_HJ_Msk;
    }
    else if (I3C_IBI_TYPE_INTERRUPT == ibi_type)
    {
        command_descriptor |= I3C_B_CMD_DESC_XFER_RNW_Msk;
    }
    else
    {
        /* Mastership request. */
    ...
    if (0 < length)
    {
        ...
        p_ctrl->p_reg->NIBIQP = i3c_b_next_data_word_calculate(
            (i3c_b_write_buffer_descriptor_t *) &p_ctrl->ibi_buffer_descriptor);
        ...
        if (sizeof(uint32_t) < length)
        {
            ...
            p_ctrl->ibi_next_word = i3c_b_next_data_word_calculate(
                (i3c_b_write_buffer_descriptor_t *) &p_ctrl->ibi_buffer_descriptor);
...
fsp_err_t R_I3C_B_IbiRead (i3c_ctrl_t * const p_api_ctrl, uint8_t * const p_data, uint32_t length)
{
    ...
    /* This function is not used in slave mode. */
    FSP_ERROR_RETURN(I3C_B_INTERNAL_STATE_SLAVE_IDLE != p_ctrl->internal_state &&
                     I3C_B_INTERNAL_STATE_SLAVE_IBI != p_ctrl->internal_state &&
                     I3C_B_INTERNAL_STATE_DISABLED != p_ctrl->internal_state,
                     FSP_ERR_INVALID_MODE);
...
fsp_err_t R_I3C_B_Close (i3c_ctrl_t * const p_api_ctrl)
{
    ...
    i3c_b_extended_cfg_t * p_extend = (i3c_b_extended_cfg_t *) p_ctrl->p_cfg->p_extend;
    ...
    R_BSP_IrqDisable(p_extend->ibi_irq);
    R_BSP_IrqDisable(p_extend->st_irq);
    R_BSP_IrqDisable(p_extend->sp_irq);
    R_BSP_IrqDisable(p_extend->ierr_irq);
    R_BSP_IrqDisable(p_extend->terr_irq);
    R_BSP_IrqDisable(p_extend->tmo_irq);
    R_BSP_IrqDisable(p_extend->abort_irq);
 ...
 * @param[in]  bitrate_setting   The bitrate setting (See @ref i3c_b_bitrate_mode_t).
...
static uint32_t i3c_b_xfer_command_calculate (uint32_t dev_index, bool rnw, uint32_t bitrate_setting, bool restart)
{
    ...
    if (rnw)
    {
        command_descriptor |= (I3C_EVENT_READ_COMPLETE << I3C_B_CMD_DESC_TID_Pos);
    }
    else
    {
        command_descriptor |= (I3C_EVENT_WRITE_COMPLETE << I3C_B_CMD_DESC_TID_Pos);
    }

    command_descriptor |= (dev_index << I3C_B_CMD_DESC_DEV_INDEX_Pos) & I3C_B_CMD_DESC_DEV_INDEX_Msk;
    command_descriptor |= (bitrate_setting << I3C_B_CMD_DESC_XFER_MODE_Pos) & I3C_B_CMD_DESC_XFER_MODE_Msk;
    command_descriptor |= (uint32_t) (rnw << I3C_B_CMD_DESC_XFER_RNW_Pos);
    command_descriptor |= I3C_B_CMD_DESC_ROC_Msk;
    command_descriptor |= (uint32_t) (!restart << I3C_B_CMD_DESC_TOC_Pos) & I3C_B_CMD_DESC_TOC_Msk;
 ...
 **********************************************************************************************************************/
static inline void i3c_b_fifo_read (i3c_b_instance_ctrl_t * p_ctrl, uint32_t bytes)
{
    ...
    while (bytes_remaining > 0)
    {
        ...
        /*
         * Store the next word of data into the read buffer. If there is not enough space, a I3C_B_EVENT_READ_BUFFER_FULL
         * event will be called to notify the application that a new read buffer is required.
         */
        i3c_b_read_buffer_store(p_ctrl,
 ...
 *                                   buffer descriptor.
 **********************************************************************************************************************/
static inline void i3c_b_read_buffer_store (i3c_b_instance_ctrl_t * const    p_ctrl,
                                            i3c_b_read_buffer_descriptor_t * p_buffer_descriptor,
                                            uint32_t                         data_word,
                                            uint32_t                         num_bytes,
                                            i3c_event_t                      buffer_full_event)
 ...
 **********************************************************************************************************************/
static inline uint32_t i3c_b_read_bytes_remaining_calculate (i3c_b_instance_ctrl_t * p_ctrl, uint32_t data_length)
{
 ...
 * @param[in]  p_ctrl                Pointer to an instance's control structure.
 **********************************************************************************************************************/
BSP_FORCE_INLINE static inline void i3c_b_fifo_write (i3c_b_instance_ctrl_t * p_ctrl)
{
    do
    {
 ...
 **********************************************************************************************************************/
BSP_FORCE_INLINE static inline uint32_t i3c_b_next_data_word_calculate (
    i3c_b_write_buffer_descriptor_t * p_buffer_descriptor)
{
 ...
 **********************************************************************************************************************/
static inline i3c_ctrl_t * i3c_b_isr_context_get (void)
{
    IRQn_Type               irq    = R_FSP_CurrentIrqGet();
    i3c_b_instance_ctrl_t * p_ctrl = (i3c_b_instance_ctrl_t *) R_FSP_IsrContextGet(irq);
...
void i3c_b_resp_isr (void)
{
    ...
    i3c_b_instance_ctrl_t * p_ctrl = i3c_b_isr_context_get();
    ...
    uint32_t data_length = (response_status_descriptor & I3C_B_RESP_STATUS_DESC_DATA_LENGTH_Msk) >>
                           I3C_B_RESP_STATUS_DESC_DATA_LENGTH_Pos;

    /* Read the ERR_STATUS field in the response descriptor. */
    uint32_t err_status = (response_status_descriptor & I3C_B_RESP_STATUS_DESC_ERR_STATUS_Msk) >>
                          I3C_B_RESP_STATUS_DESC_ERR_STATUS_Pos;
    ...
    i3c_callback_args_t callback_args;
    callback_args.event        = (i3c_event_t) (internal_state & I3C_B_INTERNAL_EVENT_MASK);
    ...
    {
#if I3C_B_CFG_MASTER_SUPPORT
        case I3C_B_INTERNAL_STATE_MASTER_ENTDAA:
        {
            /* Reset the read buffer descriptor that was used to read the slave info. */
            p_ctrl->read_buffer_descriptor = (i3c_b_read_buffer_descriptor_t) {
                0
            };
        ...
        case I3C_B_INTERNAL_STATE_MASTER_WRITE:
        case I3C_B_INTERNAL_STATE_MASTER_COMMAND_WRITE:
        {
            ...
            p_ctrl->write_buffer_descriptor = (i3c_b_write_buffer_descriptor_t) {
                0
            };
        ...
        case I3C_B_INTERNAL_STATE_MASTER_READ:
        case I3C_B_INTERNAL_STATE_MASTER_COMMAND_READ:
        {
            uint32_t bytes_remaining = i3c_b_read_bytes_remaining_calculate(p_ctrl, data_length);

            /* Read the remaining byte stored in the FIFO. */
            i3c_b_fifo_read(p_ctrl, bytes_remaining);

 #if I3C_B_ERROR_RECOVERY_VERSION_1 == I3C_B_CFG_ERROR_RECOVERY_SUPPORT || \
            I3C_B_ERROR_RECOVERY_VERSION_BOTH == I3C_B_CFG_ERROR_RECOVERY_SUPPORT

            /* If the transfer length is less than expected, the driver must perform error recovery */
            ...
            {
                if (0U == (p_ctrl->p_reg->PRSST & R_I3C_B_PRSST_CRMS_Msk))
                {
...
#if I3C_B_CFG_SLAVE_SUPPORT
        case I3C_B_INTERNAL_STATE_SLAVE_IBI:
        {
            ...
            p_ctrl->ibi_buffer_descriptor = (i3c_b_read_buffer_descriptor_t) {
                0
            };
     ...
     */
    if (0 != (ntst & R_I3C_B_NTST_TABTF_Msk))
    {
        p_ctrl->p_reg->BCTL_b.ABT = 0;
    }

    /* If a transfer error occurs, follow the error recovery operation defined in Figure
     * "Example of Error Recovery Operation Flowchart for I3C Master" and
     * "Example of Error Recovery Operation Flowchart for I3C Slave" in the user's manual.
     */
    if ((0 != (ntst & R_I3C_B_NTST_TEF_Msk)) || error_recovery_case_2)
    {
#if I3C_B_CFG_SLAVE_SUPPORT
        if (I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state)
        {
            i3c_b_slave_error_recovery(p_ctrl, I3C_B_SLAVE_ERROR_RECOVERY_TYPE_IBI);
        }
        else
#endif
        {
#if I3C_B_CFG_MASTER_SUPPORT
            i3c_b_master_error_recovery(p_ctrl, error_recovery_case_2);
#endif
        }
    }

    /* Clear error status flags. */
    p_ctrl->p_reg->NTST &= ~(R_I3C_B_NTST_TEF_Msk | R_I3C_B_NTST_TABTF_Msk);
...
void i3c_b_rx_isr (void)
{
     ...
     * during the transfer.
     */
    if (0 == (p_ctrl->p_reg->NTST & (R_I3C_B_NTST_RSQFF_Msk | R_I3C_B_NTSTE_RSPQFE_Msk)))
    {
        i3c_b_fifo_read(p_ctrl, p_ctrl->p_reg->NDBSTLV0_b.RDBLV * sizeof(uint32_t));
    }

#if I3C_B_CFG_MASTER_SUPPORT
    if (I3C_B_INTERNAL_STATE_MASTER_ENTDAA == p_ctrl->internal_state)
    {
...
void i3c_b_rcv_isr (void)
{
    ...
    /* Read the DATA_LENGTH field in the response descriptor. */
    uint32_t data_length = receive_status_descriptor & I3C_B_RECV_STATUS_DESC_DATA_LENGTH_Msk;

    /* Read the ERR_STATUS field in the response descriptor. */
    uint32_t err_status = (receive_status_descriptor & I3C_B_RECV_STATUS_DESC_ERR_STATUS_Msk) >>
                          I3C_B_RECV_STATUS_DESC_ERR_STATUS_Pos;

    i3c_callback_args_t callback_args;
    callback_args.p_context    = p_ctrl->p_cfg->p_context;
    callback_args.event_status = err_status;

    i3c_b_slave_error_recovery_type_t error_recovery_type = I3C_B_SLAVE_ERROR_RECOVERY_TYPE_OTHER;

    /* The transfer type is a normal SDR transfer. */
    if (0U == (receive_status_descriptor & I3C_B_RECV_STATUS_DESC_TRANSFER_TYPE_Msk))
    {
        /* If the transfer is a read transfer. */
        if (0U == (receive_status_descriptor & I3C_B_RECV_STATUS_DESC_SDR_R_W_TYPE_Msk))
        {
            ...
            error_recovery_type = I3C_B_SLAVE_ERROR_RECOVERY_TYPE_READ;
        }
        else
        {
            ...
            /* Set the error recovery procedure to use if there was a transfer error. */
            error_recovery_type = I3C_B_SLAVE_ERROR_RECOVERY_TYPE_WRITE;
    ...
    else
    {
        ...
        uint8_t command_code =
            (uint8_t) ((receive_status_descriptor & I3C_B_RECV_STATUS_DESC_CMD_Msk) >> I3C_B_RECV_STATUS_DESC_CMD_Pos);
            ...
            (I3C_CCC_DIRECT_SETDASA == command_code))
        {
            ...
            for (uint32_t i = 0; i < data_length_w; i++)
            {
                /*
                 * Perform dummy read.
                 * See Section "Operation Mode" (2) Slave Mode Operation (b-1) Dynamic Address Assignment Procedure
                 * in the user's manual.
                 */
            ...
            if (p_ctrl->p_reg->SVDVAD0_b.SDYADV)
            {
                ...
                uint32_t dynamic_address_w = (p_ctrl->p_reg->SVDVAD0 & R_I3C_B_SVDVAD0_SVAD_Msk);
                callback_args.dynamic_address = (uint8_t) (dynamic_address_w >> R_I3C_B_SVDVAD0_SVAD_Pos) & UINT8_MAX;
            }
        }
        else
        {
            ...
            {
                if (0 != (p_ctrl->p_reg->PRSST & R_I3C_B_PRSST_CRMS_Msk))
                {
     ...
     * Figure "Example of Error Recovery Operation Flowchart for I3C Slave" in the user's manual.
     */
    if ((0 != (ntst & (R_I3C_B_NTST_TEF_Msk | R_I3C_B_NTST_TABTF_Msk))) && (0U == p_ctrl->p_reg->NRSQSTLV_b.RSQLV))
    {
        if (I3C_B_INTERNAL_STATE_SLAVE_IDLE == p_ctrl->internal_state)
        {
            i3c_b_slave_error_recovery(p_ctrl, error_recovery_type);
        }
    }
...
void i3c_b_ibi_isr (void)
{
    ...
    i3c_b_instance_ctrl_t * p_ctrl = i3c_b_isr_context_get();
#if I3C_B_CFG_SLAVE_SUPPORT
    if (I3C_B_INTERNAL_STATE_SLAVE_IBI == p_ctrl->internal_state)
    {
        /* Write the data to the IBI queue. */
        ...
        {
            /* Calculate the next word of data that will be written to the IBI FIFO. */
            p_ctrl->ibi_next_word = i3c_b_next_data_word_calculate(
                (i3c_b_write_buffer_descriptor_t *) &p_ctrl->ibi_buffer_descriptor);
        }
    }
...
#endif
    {
        ...
        uint32_t ibi_data_length = (ibi_status & I3C_B_IBI_STATUS_DESC_LENGTH_Msk) >> I3C_B_IBI_STATUS_DESC_LENGTH_Pos;
        ...
        if (0U != (I3C_B_IBI_STATUS_DESC_LAST_STATUS_Msk & ibi_status))
        {
            /* Get the address of the IBI transfer. */
            uint8_t ibi_address = (ibi_status & I3C_B_IBI_STATUS_DESC_IBI_ID_Msk) >>
                                  (I3C_B_IBI_STATUS_DESC_IBI_ID_Pos + 1);

            /* Get the RNW bit of the IBI transfer. */
            uint8_t ibi_rnw = (ibi_status >> I3C_B_IBI_STATUS_DESC_IBI_ID_Pos) & 1U;

            uint32_t err_status =
                (ibi_status & (I3C_B_IBI_STATUS_DESC_IBI_ST_Msk | I3C_B_IBI_STATUS_DESC_ERR_STATUS_Msk)) >>
                I3C_B_IBI_STATUS_DESC_ERR_STATUS_Pos;
            i3c_callback_args_t callback_args =
            {
            ...
            if (I3C_B_HOT_JOIN_ADDRESS == ibi_address)
            {
...
/*******************************************************************************************************************//**
 * ISR for providing the I3C_B_EVENT_TIMEOUT_DETECTE events to the application:
 **********************************************************************************************************************/
void i3c_b_tmo_isr (void)
{
    /* Save context if RTOS is used */
    ...
    p_ctrl->p_reg->BST &= ~R_I3C_B_BST_TODF_Msk;
...
/*******************************************************************************************************************//**
 * ISR for providing the I3C_EVENT_INTERNAL_ERROR event to the application:
 * I3C_EVENT_INTERNAL_ERROR : An internal error can occur if too many transfers occur sequentially and overflow
 *                            the Receive Status Queue (See 25.2.7 INST: Internal Status Register in the UM).
 **********************************************************************************************************************/
void i3c_b_ierr_isr (void)
{
    /* Save context if RTOS is used */
    ...
    p_ctrl->p_reg->INST &= ~R_I3C_B_INST_INEF_Msk;
...
/*******************************************************************************************************************//**
 * ISR for handling the START condition detection IRQ.
 **********************************************************************************************************************/
void i3c_b_st_isr (void)
{
    /* Save context if RTOS is used */
...
/*******************************************************************************************************************//**
 * ISR for handling the STOP condition detection IRQ.
 **********************************************************************************************************************/
void i3c_b_sp_isr (void)
{
    /* Save context if RTOS is used */
...
/*******************************************************************************************************************//**
 * ISR for handling the Normal Transfer Error IRQ.
 **********************************************************************************************************************/
void i3c_b_terr_isr (void)
{
    /* Save context if RTOS is used */
...
/*******************************************************************************************************************//**
 * ISR for handling the Normal Transfer Abort IRQ.
 **********************************************************************************************************************/
void i3c_b_abort_isr (void)
{
    /* Save context if RTOS is used */
 ...
 * in the user's manual
 **********************************************************************************************************************/
void i3c_b_master_error_recovery (i3c_b_instance_ctrl_t * p_ctrl, bool error_recovery_case_2)
{
 #if I3C_B_ERROR_RECOVERY_VERSION_1 == I3C_B_CFG_ERROR_RECOVERY_SUPPORT || \
    I3C_B_ERROR_RECOVERY_VERSION_BOTH == I3C_B_CFG_ERROR_RECOVERY_SUPPORT

    /* Flush the Command, Rx and Tx Buffers. */
    p_ctrl->p_reg->RSTCTL = I3C_B_RSTCTRL_FIFO_FLUSH_Msk;

    /* The field will be cleared automatically upon reset completion. */
    FSP_HARDWARE_REGISTER_WAIT((p_ctrl->p_reg->RSTCTL & I3C_B_RSTCTRL_FIFO_FLUSH_Msk), 0U);
    ...
    if (error_recovery_case_2)
    {
         ...
         * software reset. */
        p_ctrl->p_reg->RSTCTL = R_I3C_B_RSTCTL_INTLRST_Msk;
        p_ctrl->p_reg->RSTCTL = 0;

        /* Restore the current master setting. */
        p_ctrl->p_reg->PRSST = (uint32_t) (R_I3C_B_PRSST_CRMS_Msk | R_I3C_B_PRSST_PRSSTWP_Msk);
    ...
    if (0U == p_ctrl->p_reg->PRSTDBG_b.SDILV)
    {
        ...
        uint32_t clock_frequency = R_FSP_SystemClockHzGet(FSP_PRIV_CLOCK_P4CLK);

        i3c_b_extended_cfg_t * p_extend = (i3c_b_extended_cfg_t *) p_ctrl->p_cfg->p_extend;

        /* Get the low and high period in PCLKD ticks. */
        uint32_t pclkd_low_period = (p_extend->bitrate_settings.stdbr & R_I3C_B_STDBR_SBRLO_Msk) >>
                                    R_I3C_B_STDBR_SBRLO_Pos;
        uint32_t pclkd_high_period = (p_extend->bitrate_settings.stdbr & R_I3C_B_STDBR_SBRHO_Msk) >>
                                     R_I3C_B_STDBR_SBRHO_Pos;

        /* Calculate the high and low period for SCL. */
        uint32_t high_frequency = clock_frequency / pclkd_high_period;
        uint32_t low_frequency  = clock_frequency / pclkd_low_period;
        ...
        if (bcnt_zero)
        {
            ...
            p_ctrl->p_reg->OUTCTL = R_I3C_B_OUTCTL_SDOC_Msk | R_I3C_B_OUTCTL_SOCWP_Msk;
            ...
            {
                /* Write SCL high. */
                p_ctrl->p_reg->OUTCTL = R_I3C_B_OUTCTL_SDOC_Msk | R_I3C_B_OUTCTL_SCOC_Msk |
                                        R_I3C_B_OUTCTL_SOCWP_Msk;
            ...
            p_ctrl->p_reg->OUTCTL = R_I3C_B_OUTCTL_SOCWP_Msk;

            R_BSP_SoftwareDelay(low_delay_us, BSP_DELAY_UNITS_MICROSECONDS);

            /* Write SCL high. */
            p_ctrl->p_reg->OUTCTL = R_I3C_B_OUTCTL_SCOC_Msk | R_I3C_B_OUTCTL_SOCWP_Msk;

            R_BSP_SoftwareDelay(high_delay_us, BSP_DELAY_UNITS_MICROSECONDS);

            /* Write SDA anb SCL high to complete the stop condition. */
            p_ctrl->p_reg->OUTCTL = R_I3C_B_OUTCTL_SDOC_Msk | R_I3C_B_OUTCTL_SCOC_Msk | R_I3C_B_OUTCTL_SOCWP_Msk;
        }
    }
 #endif

 #if I3C_B_ERROR_RECOVERY_VERSION_2 == I3C_B_CFG_ERROR_RECOVERY_SUPPORT || \
    I3C_B_ERROR_RECOVERY_VERSION_BOTH == I3C_B_CFG_ERROR_RECOVERY_SUPPORT
 ...
 * in the user's manual
 **********************************************************************************************************************/
void i3c_b_slave_error_recovery (i3c_b_instance_ctrl_t * p_ctrl, i3c_b_slave_error_recovery_type_t recovery_type)
{
    switch (recovery_type)
    {
        case I3C_B_SLAVE_ERROR_RECOVERY_TYPE_WRITE:
        {
        ...
        case I3C_B_SLAVE_ERROR_RECOVERY_TYPE_READ:
        {
            /* Flush the Command and Rx Data FIFO. */
            p_ctrl->p_reg->RSTCTL = R_I3C_B_RSTCTL_RDBRST_Msk;
            break;
        }

        case I3C_B_SLAVE_ERROR_RECOVERY_TYPE_IBI:
        {
            /* Flush the Command and Rx Data FIFO. */
            p_ctrl->p_reg->RSTCTL = R_I3C_B_RSTCTL_CMDQRST_Msk;
            break;
        }
    ...
    /* Wait for Bus Available Condition. */
    FSP_HARDWARE_REGISTER_WAIT((p_ctrl->p_reg->BCST & R_I3C_B_BCST_BAVLF_Msk), R_I3C_B_BCST_BAVLF_Msk);

    /* Wait for start condition to be cleared. */
    FSP_HARDWARE_REGISTER_WAIT((p_ctrl->p_reg->BST & R_I3C_B_BST_STCNDDF_Msk), 0);
    ...
    uint32_t expected_bus_available_time =
        (1000000U * p_ctrl->p_reg->BAVLCDT + clock_frequency - 1) / clock_frequency; // NOLINT(readability-magic-numbers)
    ...
    if (0 == (p_ctrl->p_reg->BCST & R_I3C_B_BCST_BAVLF_Msk))
    {
        while (0 == (p_ctrl->p_reg->BST & R_I3C_B_BST_STCNDDF_Msk))
        {
            /* Perform internal software reset. */
            p_ctrl->p_reg->RSTCTL = R_I3C_B_RSTCTL_INTLRST_Msk;
